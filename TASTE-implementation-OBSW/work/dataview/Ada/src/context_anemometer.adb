...
package body Context_anemometer with SPARK_Mode is
...
end asn1SccContext_anemometer_Equal;

function asn1SccContext_anemometer_Init return asn1SccContext_anemometer
is
    val: asn1SccContext_anemometer;
begin

    --set gpio_pin 
    val.gpio_pin := TASTE_BasicTypes.asn1SccT_UInt32_Init;
	pragma Warnings (Off, "object ""val"" is always");
    return val;
	pragma Warnings (On, "object ""val"" is always");
end asn1SccContext_anemometer_Init;
...
is
    ...
    pragma Warnings (On, "initialization of ret has no effect");        
begin
    ret := TASTE_BasicTypes.asn1SccT_UInt32_IsConstraintValid(val.gpio_pin);
    return ret;
end asn1SccContext_anemometer_IsConstraintValid;
