...
ERR_DATE_TIME:constant Integer := 7008; 
ERR_DATE_TIME_DAY_2:constant Integer := 6931; 
ERR_DATE_TIME_MONTH_2:constant Integer := 6945; 
ERR_DATE_TIME_YEAR_2:constant Integer := 6959; 
ERR_DATE_TIME_HOUR_2:constant Integer := 6973; 
ERR_DATE_TIME_MINUTE_2:constant Integer := 6987; 
ERR_DATE_TIME_SECOND_2:constant Integer := 7001; 
...
-- asn1SccTC --------------------------------------------
-- asn1SccTC_heater_of_htl --------------------------------------------
subtype asn1SccTC_heater_of_htl_max_min_index_range is Integer range 0..1;
type asn1SccTC_heater_of_htl_max_min is (asn1Sccmax, asn1Sccmin) with Size => adaasn1rtl.Enumerated_Size;
for asn1SccTC_heater_of_htl_max_min use
    (asn1Sccmax => 0, asn1Sccmin => 1);

subtype asn1SccTC_heater_of_htl_index_range is Integer range 0..1;

type asn1SccTC_heater_of_htl_selection is (power_manual_PRESENT, max_min_PRESENT);
for asn1SccTC_heater_of_htl_selection use
    (power_manual_PRESENT => 1, max_min_PRESENT => 2);
for asn1SccTC_heater_of_htl_selection'Size use 32;

type asn1SccTC_heater_of_htl(kind : asn1SccTC_heater_of_htl_selection:= power_manual_PRESENT) is 
record
    case kind is
    when power_manual_PRESENT =>
            power_manual: asn1SccT_Float;
    when max_min_PRESENT =>
            max_min: asn1SccTC_heater_of_htl_max_min;
    end case;
end record;

for asn1SccTC_heater_of_htl use 
record
...
subtype asn1SccTC_tc74s_temp_celsius_index is Integer range 1..5;
type asn1SccTC_tc74s_temp_celsius_array is array (asn1SccTC_tc74s_temp_celsius_index) of asn1SccT_Float;
type asn1SccTC_tc74s_temp_celsius is  record
    Data  : asn1SccTC_tc74s_temp_celsius_array;
end record;
-- asn1SccTC_pt1000s_temp_celsius --------------------------------------------


subtype asn1SccTC_pt1000s_temp_celsius_index is Integer range 1..7;
type asn1SccTC_pt1000s_temp_celsius_array is array (asn1SccTC_pt1000s_temp_celsius_index) of asn1SccT_Float;
type asn1SccTC_pt1000s_temp_celsius is  record
    Data  : asn1SccTC_pt1000s_temp_celsius_array;
end record;

type asn1SccTC is record 
    heater_of_htl : asn1SccTC_heater_of_htl;
    tc74s_temp_celsius : asn1SccTC_tc74s_temp_celsius;
    pt1000s_temp_celsius : asn1SccTC_pt1000s_temp_celsius;
    pressure1_mbar : asn1SccT_Float;
    pressure2_mbar : asn1SccT_Float;
end record;


function asn1SccTC_heater_of_htl_max_min_Equal(val1, val2 : asn1SccTC_heater_of_htl_max_min) return Boolean;

function asn1SccTC_heater_of_htl_Equal(val1, val2 : asn1SccTC_heater_of_htl) return Boolean;
...
function asn1SccTC_heater_of_htl_max_min_Init return asn1SccTC_heater_of_htl_max_min;
function asn1SccTC_heater_of_htl_Init return asn1SccTC_heater_of_htl;
...
ERR_TC:constant Integer := 6616; 
ERR_TC_HEATER_OF_HTL:constant Integer := 6539; 
ERR_TC_HEATER_OF_HTL_POWER_MANUAL_2:constant Integer := 6525; 
ERR_TC_HEATER_OF_HTL_MAX_MIN:constant Integer := 6532; 
ERR_TC_TC74S_TEMP_CELSIUS:constant Integer := 6560; 
ERR_TC_TC74S_TEMP_CELSIUS_ELM_2:constant Integer := 6553; 
ERR_TC_PT1000S_TEMP_CELSIUS:constant Integer := 6581; 
ERR_TC_PT1000S_TEMP_CELSIUS_ELM_2:constant Integer := 6574; 
ERR_TC_PRESSURE1_MBAR_2:constant Integer := 6595; 
ERR_TC_PRESSURE2_MBAR_2:constant Integer := 6609; 
...
ERR_OBSW_DP_DATA:constant Integer := 3830; 
ERR_OBSW_DP_DATA_MISSION_TIME_2:constant Integer := 2010; 
ERR_OBSW_DP_DATA_GPS:constant Integer := 2262; 
ERR_OBSW_DP_DATA_GPS_DATA_2:constant Integer := 2227; 
ERR_OBSW_DP_DATA_GPS_GPS_TIME_2:constant Integer := 2241; 
ERR_OBSW_DP_DATA_GPS_MISSION_TIME_2:constant Integer := 2255; 
ERR_OBSW_DP_DATA_IMU:constant Integer := 2731; 
ERR_OBSW_DP_DATA_IMU_DATA_2:constant Integer := 2696; 
ERR_OBSW_DP_DATA_IMU_GPS_TIME_2:constant Integer := 2710; 
ERR_OBSW_DP_DATA_IMU_MISSION_TIME_2:constant Integer := 2724; 
ERR_OBSW_DP_DATA_TC74S:constant Integer := 2815; 
ERR_OBSW_DP_DATA_TC74S_DATA_2:constant Integer := 2780; 
ERR_OBSW_DP_DATA_TC74S_GPS_TIME_2:constant Integer := 2794; 
ERR_OBSW_DP_DATA_TC74S_MISSION_TIME_2:constant Integer := 2808; 
ERR_OBSW_DP_DATA_PT1000S:constant Integer := 2962; 
ERR_OBSW_DP_DATA_PT1000S_DATA_2:constant Integer := 2927; 
ERR_OBSW_DP_DATA_PT1000S_GPS_TIME_2:constant Integer := 2941; 
ERR_OBSW_DP_DATA_PT1000S_MISSION_TIME_2:constant Integer := 2955; 
ERR_OBSW_DP_DATA_PS1:constant Integer := 3291; 
ERR_OBSW_DP_DATA_PS1_DATA_2:constant Integer := 3256; 
ERR_OBSW_DP_DATA_PS1_GPS_TIME_2:constant Integer := 3270; 
ERR_OBSW_DP_DATA_PS1_MISSION_TIME_2:constant Integer := 3284; 
ERR_OBSW_DP_DATA_PS2:constant Integer := 3620; 
ERR_OBSW_DP_DATA_PS2_DATA_2:constant Integer := 3585; 
ERR_OBSW_DP_DATA_PS2_GPS_TIME_2:constant Integer := 3599; 
ERR_OBSW_DP_DATA_PS2_MISSION_TIME_2:constant Integer := 3613; 
ERR_OBSW_DP_DATA_HEATER1:constant Integer := 3697; 
ERR_OBSW_DP_DATA_HEATER1_DATA_2:constant Integer := 3662; 
ERR_OBSW_DP_DATA_HEATER1_GPS_TIME_2:constant Integer := 3676; 
ERR_OBSW_DP_DATA_HEATER1_MISSION_TIME_2:constant Integer := 3690; 
ERR_OBSW_DP_DATA_HEATER2:constant Integer := 3774; 
ERR_OBSW_DP_DATA_HEATER2_DATA_2:constant Integer := 3739; 
ERR_OBSW_DP_DATA_HEATER2_GPS_TIME_2:constant Integer := 3753; 
ERR_OBSW_DP_DATA_HEATER2_MISSION_TIME_2:constant Integer := 3767; 
ERR_OBSW_DP_DATA_ANEMOMETER:constant Integer := 3823; 
ERR_OBSW_DP_DATA_ANEMOMETER_DATA_2:constant Integer := 3788; 
ERR_OBSW_DP_DATA_ANEMOMETER_GPS_TIME_2:constant Integer := 3802; 
ERR_OBSW_DP_DATA_ANEMOMETER_MISSION_TIME_2:constant Integer := 3816; 
...
ERR_OBSW_DP_SINGLEDATA:constant Integer := 5650; 
ERR_OBSW_DP_SINGLEDATA_GPS:constant Integer := 4082; 
ERR_OBSW_DP_SINGLEDATA_GPS_DATA_2:constant Integer := 4047; 
ERR_OBSW_DP_SINGLEDATA_GPS_GPS_TIME_2:constant Integer := 4061; 
ERR_OBSW_DP_SINGLEDATA_GPS_MISSION_TIME_2:constant Integer := 4075; 
ERR_OBSW_DP_SINGLEDATA_IMU:constant Integer := 4551; 
ERR_OBSW_DP_SINGLEDATA_IMU_DATA_2:constant Integer := 4516; 
ERR_OBSW_DP_SINGLEDATA_IMU_GPS_TIME_2:constant Integer := 4530; 
ERR_OBSW_DP_SINGLEDATA_IMU_MISSION_TIME_2:constant Integer := 4544; 
ERR_OBSW_DP_SINGLEDATA_TC74S:constant Integer := 4635; 
ERR_OBSW_DP_SINGLEDATA_TC74S_DATA_2:constant Integer := 4600; 
ERR_OBSW_DP_SINGLEDATA_TC74S_GPS_TIME_2:constant Integer := 4614; 
ERR_OBSW_DP_SINGLEDATA_TC74S_MISSION_TIME_2:constant Integer := 4628; 
ERR_OBSW_DP_SINGLEDATA_PT1000S:constant Integer := 4782; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_DATA_2:constant Integer := 4747; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_GPS_TIME_2:constant Integer := 4761; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_MISSION_TIME_2:constant Integer := 4775; 
ERR_OBSW_DP_SINGLEDATA_PS1:constant Integer := 5111; 
ERR_OBSW_DP_SINGLEDATA_PS1_DATA_2:constant Integer := 5076; 
ERR_OBSW_DP_SINGLEDATA_PS1_GPS_TIME_2:constant Integer := 5090; 
ERR_OBSW_DP_SINGLEDATA_PS1_MISSION_TIME_2:constant Integer := 5104; 
ERR_OBSW_DP_SINGLEDATA_PS2:constant Integer := 5440; 
ERR_OBSW_DP_SINGLEDATA_PS2_DATA_2:constant Integer := 5405; 
ERR_OBSW_DP_SINGLEDATA_PS2_GPS_TIME_2:constant Integer := 5419; 
ERR_OBSW_DP_SINGLEDATA_PS2_MISSION_TIME_2:constant Integer := 5433; 
ERR_OBSW_DP_SINGLEDATA_HEATER1:constant Integer := 5517; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_DATA_2:constant Integer := 5482; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_GPS_TIME_2:constant Integer := 5496; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_MISSION_TIME_2:constant Integer := 5510; 
ERR_OBSW_DP_SINGLEDATA_HEATER2:constant Integer := 5594; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_DATA_2:constant Integer := 5559; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_GPS_TIME_2:constant Integer := 5573; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_MISSION_TIME_2:constant Integer := 5587; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER:constant Integer := 5643; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_DATA_2:constant Integer := 5608; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_GPS_TIME_2:constant Integer := 5622; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_MISSION_TIME_2:constant Integer := 5636; 
...
ERR_ATT_GUI:constant Integer := 7575; 
ERR_ATT_GUI_GPS_2:constant Integer := 7225; 
ERR_ATT_GUI_GPS_DATE_TIME_2:constant Integer := 7323; 
ERR_ATT_GUI_IMU:constant Integer := 7568; 
ERR_ATT_GUI_IMU_MGT_MGAUSS_2:constant Integer := 7379; 
ERR_ATT_GUI_IMU_ACCEL_MG_2:constant Integer := 7435; 
ERR_ATT_GUI_IMU_GYRO_MDPS_2:constant Integer := 7491; 
ERR_ATT_GUI_IMU_TEMP_CELSIUS_2:constant Integer := 7505; 
ERR_ATT_GUI_IMU_MGT_VALID_2:constant Integer := 7519; 
ERR_ATT_GUI_IMU_ACC_VALID_2:constant Integer := 7533; 
ERR_ATT_GUI_IMU_GYRO_VALID_2:constant Integer := 7547; 
ERR_ATT_GUI_IMU_TEMP_VALID_2:constant Integer := 7561; 
...
ERR_PS_GUI:constant Integer := 7624; 
ERR_PS_GUI_PRESSURE_MBAR_2:constant Integer := 7589; 
ERR_PS_GUI_TEMPERATURE_CELSIUS_2:constant Integer := 7603; 
ERR_PS_GUI_VALIDITY_2:constant Integer := 7617; 
...
ERR_ENV_GUI:constant Integer := 7834; 
ERR_ENV_GUI_PRESSURE_SENSOR_1_2:constant Integer := 7680; 
ERR_ENV_GUI_PRESSURE_SENSOR_2_2:constant Integer := 7736; 
ERR_ENV_GUI_ANEMOMETER:constant Integer := 7785; 
ERR_ENV_GUI_ANEMOMETER_GLOBAL_COUNTER_2:constant Integer := 7750; 
ERR_ENV_GUI_ANEMOMETER_TEMPERATURE_CELSIUS_2:constant Integer := 7764; 
ERR_ENV_GUI_ANEMOMETER_TEMPERATURE_VALIDITY_2:constant Integer := 7778; 
ERR_ENV_GUI_HEATER_2:constant Integer := 7827; 
...
ERR_TM_STATE_HTL_2:constant Integer := 6504; 
...
ERR_HTL_GUI:constant Integer := 6917; 
ERR_HTL_GUI_STATE_2:constant Integer := 6630; 
ERR_HTL_GUI_HEATER_2:constant Integer := 6672; 
ERR_HTL_GUI_DELTA_T_2:constant Integer := 6686; 
ERR_HTL_GUI_PT1000S:constant Integer := 6812; 
ERR_HTL_GUI_PT1000S_AIRE_ABAJO_2:constant Integer := 6700; 
ERR_HTL_GUI_PT1000S_AIRE_ARRIBA_2:constant Integer := 6714; 
ERR_HTL_GUI_PT1000S_PLACA_ABAJO_2:constant Integer := 6728; 
ERR_HTL_GUI_PT1000S_PLACA_ARRIBA_2:constant Integer := 6742; 
ERR_HTL_GUI_PT1000S_INFINITO_2:constant Integer := 6756; 
ERR_HTL_GUI_PT1000S_EXTERIOR_2:constant Integer := 6770; 
ERR_HTL_GUI_PT1000S_VCC_VOLTS_2:constant Integer := 6784; 
ERR_HTL_GUI_PT1000S_VALIDITY:constant Integer := 6805; 
ERR_HTL_GUI_PT1000S_VALIDITY_ELM_2:constant Integer := 6798; 
ERR_HTL_GUI_TC74S:constant Integer := 6910; 
ERR_HTL_GUI_TC74S_X_POSITIVE_2:constant Integer := 6826; 
ERR_HTL_GUI_TC74S_X_NEGATIVE_2:constant Integer := 6840; 
ERR_HTL_GUI_TC74S_Y_POSITIVE_2:constant Integer := 6854; 
ERR_HTL_GUI_TC74S_Y_NEGATIVE_2:constant Integer := 6868; 
ERR_HTL_GUI_TC74S_Z_TECHO_2:constant Integer := 6882; 
ERR_HTL_GUI_TC74S_VALIDITY:constant Integer := 6903; 
ERR_HTL_GUI_TC74S_VALIDITY_ELM_2:constant Integer := 6896; 
...
ERR_OBSW_DP_FILTER:constant Integer := 5657; 
