...
## Software design
In this subsection we give a brief description of the [OBSW of TASEC-Lab implemented with the TASTE tool-set](./TASTE-implementation).
...
The *Bus Handlers* and *Equipment Handlers* layers were developed independently from TASTE and are described in more detailed in the [README](./HAL/README.md) of the HAL directory.
