...
package Heattransferlab with Elaborate_Body is
   ...
   function To_TC_heater_of_htl_selection (Src : TASEC_LAB_B2SPACE_DATAVIEW.asn1SccTC_heater_of_htl_selection) return Heattransferlab_Datamodel.asn1SccTC_heater_of_htl_selection is (Heattransferlab_Datamodel.asn1SccTC_heater_of_htl_selection'Enum_Val (Src'Enum_Rep));
   ...
   procedure RI_0_setOnOffH2 (Cmd : in out asn1SccHeater_On_Off) renames Heattransferlab_RI.setOnOffH2;
