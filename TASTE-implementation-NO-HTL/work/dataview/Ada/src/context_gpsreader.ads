...
ERR_CONTEXT_GPSREADER:constant Integer := 8023; 
ERR_CONTEXT_GPSREADER_MAX_RETRIES_2:constant Integer := 8002; 
ERR_CONTEXT_GPSREADER_WAITING_TIME_PER_RETRY_US_2:constant Integer := 8016; 
