...
flag asn1SccIMU_Queue_Equal(const asn1SccIMU_Queue* pVal1, const asn1SccIMU_Queue* pVal2)
{
    ...
    {
    	ret = asn1SccIMU_Queue_elem_Equal((&(pVal1->arr[i1])), (&(pVal2->arr[i1])));
    }
...
void asn1SccIMU_Queue_Initialize(asn1SccIMU_Queue* pVal)
{
	...
	i1 = 0;
	while (i1< 50) {
	    asn1SccIMU_Queue_elem_Initialize((&(pVal->arr[i1])));
	    i1 = i1 + 1;
	}
...
flag asn1SccIMU_Queue_IsConstraintValid(const asn1SccIMU_Queue* pVal, int* pErrCode)
{
    ...
    for(i1 = 0; ret && i1 < 50; i1++) 
    {
    	ret = asn1SccIMU_All_Data_IsConstraintValid((&(pVal->arr[i1].data)), pErrCode);
    	if (ret) {
    	    ret = asn1SccT_Double_IsConstraintValid((&(pVal->arr[i1].gps_time)), pErrCode);
    	    if (ret) {
    	        ret = asn1SccT_Double_IsConstraintValid((&(pVal->arr[i1].mission_time)), pErrCode);
    	    }
    	}
    }
...
flag asn1SccIMU_Queue_Encode(const asn1SccIMU_Queue* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	int i1;
	ret = bCheckConstraints ? asn1SccIMU_Queue_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
	    	
	    for(i1=0; (i1 < (int)50) && ret; i1++) 
	    {
	    	/*Encode data */
	    	ret = asn1SccIMU_All_Data_Encode((&(pVal->arr[i1].data)), pBitStrm, pErrCode, FALSE);
	    	if (ret) {
	    	    /*Encode gps_time */
	    	    ret = asn1SccT_Double_Encode((&(pVal->arr[i1].gps_time)), pBitStrm, pErrCode, FALSE);
	    	    if (ret) {
	    	        /*Encode mission_time */
	    	        ret = asn1SccT_Double_Encode((&(pVal->arr[i1].mission_time)), pBitStrm, pErrCode, FALSE);
	    	    }
	    	}
	    }
    } /*COVERAGE_IGNORE*/
...
flag asn1SccIMU_Queue_Decode(asn1SccIMU_Queue* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	{
		/*Decode data */
		ret = asn1SccIMU_All_Data_Decode((&(pVal->arr[i1].data)), pBitStrm, pErrCode);
		if (ret) {
		    /*Decode gps_time */
		    ret = asn1SccT_Double_Decode((&(pVal->arr[i1].gps_time)), pBitStrm, pErrCode);
		    if (ret) {
		        /*Decode mission_time */
		        ret = asn1SccT_Double_Decode((&(pVal->arr[i1].mission_time)), pBitStrm, pErrCode);
		    }
		}
	}

	return ret  && asn1SccIMU_Queue_IsConstraintValid(pVal, pErrCode);
}
...
flag asn1SccIMU_Queue_ACN_Encode(const asn1SccIMU_Queue* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	if (ret) {
	    ...
	    {
	    	/*Encode data */
	    	ret = asn1SccIMU_All_Data_ACN_Encode((&(pVal->arr[i1].data)), pBitStrm, pErrCode, FALSE);
	    	if (ret) {
	    	    /*Encode gps_time */
	    	    ret = asn1SccT_Double_ACN_Encode((&(pVal->arr[i1].gps_time)), pBitStrm, pErrCode, FALSE);
	    	    if (ret) {
	    	        /*Encode mission_time */
	    	        ret = asn1SccT_Double_ACN_Encode((&(pVal->arr[i1].mission_time)), pBitStrm, pErrCode, FALSE);
	    	    }
...
flag asn1SccIMU_Queue_ACN_Decode(asn1SccIMU_Queue* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	{
		/*Decode data */
		ret = asn1SccIMU_All_Data_ACN_Decode((&(pVal->arr[i1].data)), pBitStrm, pErrCode);
		if (ret) {
		    /*Decode gps_time */
		    ret = asn1SccT_Double_ACN_Decode((&(pVal->arr[i1].gps_time)), pBitStrm, pErrCode);
		    if (ret) {
		        /*Decode mission_time */
		        ret = asn1SccT_Double_ACN_Decode((&(pVal->arr[i1].mission_time)), pBitStrm, pErrCode);
		    }
...
flag asn1SccWD_TIMEOUT_Encode(const asn1SccWD_TIMEOUT* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	ret = bCheckConstraints ? asn1SccWD_TIMEOUT_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret) {
...
flag asn1SccWD_TIMEOUT_Decode(asn1SccWD_TIMEOUT* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = ret ? 0 : ERR_UPER_DECODE_WD_TIMEOUT;
	...
	return ret  && asn1SccWD_TIMEOUT_IsConstraintValid(pVal, pErrCode);
}
