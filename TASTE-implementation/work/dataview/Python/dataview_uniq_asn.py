...
class IMU_Queue(COMMON):
    def __init__(self, ptr=None):
        super(IMU_Queue, self).__init__("IMU_Queue", ptr)
    ...
    def GSER(self):
        ...
        def emitElem(path, i):
            ...
            lines.append("{")
            lines.append("   x-axis ")
            lines.append("    "+str(path[i].data.mgt_raw.x_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   y-axis ")
            lines.append("    "+str(path[i].data.mgt_raw.y_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   z-axis ")
            lines.append("    "+str(path[i].data.mgt_raw.z_axis.Get()))
            path.Reset(state)
            lines.append("}")
            path.Reset(state)
            lines.append(', ')
            ...
            lines.append("{")
            lines.append("   x-axis ")
            lines.append("    "+str(path[i].data.mgt_mgauss.x_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   y-axis ")
            lines.append("    "+str(path[i].data.mgt_mgauss.y_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   z-axis ")
            lines.append("    "+str(path[i].data.mgt_mgauss.z_axis.Get()))
            path.Reset(state)
            lines.append("}")
            path.Reset(state)
            lines.append(', ')
            ...
            lines.append("{")
            lines.append("   x-axis ")
            lines.append("    "+str(path[i].data.accel_raw.x_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   y-axis ")
            lines.append("    "+str(path[i].data.accel_raw.y_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   z-axis ")
            lines.append("    "+str(path[i].data.accel_raw.z_axis.Get()))
            path.Reset(state)
            lines.append("}")
            path.Reset(state)
            lines.append(', ')
            ...
            lines.append("{")
            lines.append("   x-axis ")
            lines.append("    "+str(path[i].data.accel_mg.x_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   y-axis ")
            lines.append("    "+str(path[i].data.accel_mg.y_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   z-axis ")
            lines.append("    "+str(path[i].data.accel_mg.z_axis.Get()))
            path.Reset(state)
            lines.append("}")
            path.Reset(state)
            lines.append(', ')
            ...
            lines.append("{")
            lines.append("   x-axis ")
            lines.append("    "+str(path[i].data.gyro_raw.x_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   y-axis ")
            lines.append("    "+str(path[i].data.gyro_raw.y_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   z-axis ")
            lines.append("    "+str(path[i].data.gyro_raw.z_axis.Get()))
            path.Reset(state)
            lines.append("}")
            path.Reset(state)
            lines.append(', ')
            ...
            lines.append("{")
            lines.append("   x-axis ")
            lines.append("    "+str(path[i].data.gyro_mdps.x_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   y-axis ")
            lines.append("    "+str(path[i].data.gyro_mdps.y_axis.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("   z-axis ")
            lines.append("    "+str(path[i].data.gyro_mdps.z_axis.Get()))
            path.Reset(state)
            lines.append("}")
            path.Reset(state)
            lines.append(', ')
            lines.append("  temp-raw ")
            lines.append("   "+str(path[i].data.temp_raw.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("  temp-celsius ")
            lines.append("   "+str(path[i].data.temp_celsius.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append("  mgt-valid ")
            lines.append("   "+{'0': 'valid', '1': 'invalid'}[str(path[i].data.mgt_valid.Get())])
            path.Reset(state)
            lines.append(', ')
            lines.append("  acc-valid ")
            lines.append("   "+{'0': 'valid', '1': 'invalid'}[str(path[i].data.acc_valid.Get())])
            path.Reset(state)
            lines.append(', ')
            lines.append("  gyro-valid ")
            lines.append("   "+{'0': 'valid', '1': 'invalid'}[str(path[i].data.gyro_valid.Get())])
            path.Reset(state)
            lines.append(', ')
            lines.append("  temp-valid ")
            lines.append("   "+{'0': 'valid', '1': 'invalid'}[str(path[i].data.temp_valid.Get())])
            path.Reset(state)
            lines.append("}")
            path.Reset(state)
            lines.append(', ')
            lines.append(" gps-time ")
            lines.append("  "+str(path[i].gps_time.Get()))
            path.Reset(state)
            lines.append(', ')
            lines.append(" mission-time ")
            lines.append("  "+str(path[i].mission_time.Get()))
            path.Reset(state)
            lines.append("}")
            path.Reset(state)
        state = self.GetState()
...
class TC(COMMON):
    ...
    def GSER(self):
        ''' Return the GSER representation of the value '''
        lines = []
        if self.kind.Get() == DV.heater_commands_PRESENT:
         lines.append("heater-commands: ")
         lines.append("{")
         lines.append(" heater-of-HTL ")
         lines.append("{")
         lines.append("  heater ")
         lines.append("   "+{'0': 'heater-HTL', '1': 'heater-anemo'}[str(self.heater_commands.heater_of_HTL.heater.Get())])
         lines.append(', ')
         lines.append("  command ")
         if self.heater_commands.heater_of_HTL.command.kind.Get() == DV.power_manual_PRESENT:
          lines.append("   power-manual: ")
          lines.append("    "+str(self.heater_commands.heater_of_HTL.command.power_manual.Get()))
         if self.heater_commands.heater_of_HTL.command.kind.Get() == DV.max_min_PRESENT:
          lines.append("   max-min: ")
          lines.append("    "+{'0': 'max', '1': 'min'}[str(self.heater_commands.heater_of_HTL.command.max_min.Get())])
         lines.append("}")
         lines.append(', ')
         lines.append(" config-of-HTL ")
         lines.append("{")
         lines.append("  press-5km ")
         lines.append("   "+str(self.heater_commands.config_of_HTL.press_5km.Get()))
         lines.append(', ')
         lines.append("  press-10km ")
         lines.append("   "+str(self.heater_commands.config_of_HTL.press_10km.Get()))
         lines.append(', ')
         lines.append("  press-18km ")
         lines.append("   "+str(self.heater_commands.config_of_HTL.press_18km.Get()))
         lines.append(', ')
         lines.append("  a1-duration-emergency-secs ")
         lines.append("   "+str(self.heater_commands.config_of_HTL.a1_duration_emergency_secs.Get()))
         lines.append(', ')
         lines.append("  a1-duration-max-secs ")
         lines.append("   "+str(self.heater_commands.config_of_HTL.a1_duration_max_secs.Get()))
         lines.append(', ')
         lines.append("  a2-duration-max-secs ")
         lines.append("   "+str(self.heater_commands.config_of_HTL.a2_duration_max_secs.Get()))
         lines.append(', ')
         lines.append("  f1-duration-secs ")
         lines.append("   "+str(self.heater_commands.config_of_HTL.f1_duration_secs.Get()))
         lines.append(', ')
         lines.append("  f2-duration-secs ")
         lines.append("   "+str(self.heater_commands.config_of_HTL.f2_duration_secs.Get()))
         lines.append("}")
         lines.append("}")
        if self.kind.Get() == DV.system_commands_PRESENT:
         lines.append("system-commands: ")
         lines.append(" "+{'0': 'stop'}[str(self.system_commands.Get())])
