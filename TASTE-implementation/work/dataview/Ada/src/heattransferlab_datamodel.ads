...
type asn1SccHeattransferlab_States is (asn1Sccf3, asn1Sccerror, asn1Scca2, asn1Scca1, asn1Sccselectstate, asn1Sccf2, asn1Sccf1) with Size => adaasn1rtl.Enumerated_Size;
for asn1SccHeattransferlab_States use
    (asn1Sccf3 => 0, asn1Sccerror => 1, asn1Scca2 => 2, asn1Scca1 => 3, asn1Sccselectstate => 4, asn1Sccf2 => 5, asn1Sccf1 => 6);
...
ERR_HEATTRANSFERLAB_CONTEXT_F1_DURATION_2:constant Integer := 288; 
ERR_HEATTRANSFERLAB_CONTEXT_F1_RELATIVE_DURATION_MAX_2:constant Integer := 302; 
ERR_HEATTRANSFERLAB_CONTEXT_F1_DURATION_MAX_2:constant Integer := 316; 
ERR_HEATTRANSFERLAB_CONTEXT_M_2:constant Integer := 330; 
ERR_HEATTRANSFERLAB_CONTEXT_F2_STARTED_2:constant Integer := 344; 
ERR_HEATTRANSFERLAB_CONTEXT_F2_DURATION_2:constant Integer := 358; 
