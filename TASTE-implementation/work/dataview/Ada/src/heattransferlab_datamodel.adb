                                        ...
                                        if ret then
                                            ...
                                            if ret then
                                                ...
                                                if ret then
                                                    ...
                                                    if ret then
                                                        ret := (val1.a1_started = val2.a1_started);
                                                        ...
                                                        if ret then
                                                            ...
                                                            if ret then
                                                                ...
                                                                if ret then
                                                                    ret := (val1.a2_started = val2.a2_started);
                                                                            ...
                                                                            if ret then
                                                                                ...
                                                                                if ret then
                                                                                    ...
                                                                                    if ret then
                                                                                        ...
                                                                                        if ret then
                                                                                            ret := (val1.f1_first_it = val2.f1_first_it);
                                                                                                ...
                                                                                                if ret then
                                                                                                    ...
                                                                                                    if ret then
                                                                                                        ...
                                                                                                        if ret then
                                                                                                            ...
                                                                                                            if ret then
                                                                                                                ret := (val1.f2_first_it = val2.f2_first_it);
...
begin
    ...
    --set a1_started 
    val.a1_started := TASTE_BasicTypes.asn1SccT_Boolean_Init;
    ...
    --set a2_started 
    val.a2_started := TASTE_BasicTypes.asn1SccT_Boolean_Init;
    --set power_a2 
    ...
    --set f1_first_it 
    val.f1_first_it := TASTE_BasicTypes.asn1SccT_Boolean_Init;
    ...
    --set f2_first_it 
    val.f2_first_it := TASTE_BasicTypes.asn1SccT_Boolean_Init;
                                    ...
                                    if ret.Success then
                                        ...
                                        if ret.Success then
                                            ...
                                            if ret.Success then
                                                ...
                                                if ret.Success then
                                                    ret := TASTE_BasicTypes.asn1SccT_Boolean_IsConstraintValid(val.a1_started);
                                                    if ret.Success then
                                                        ...
                                                        if ret.Success then
                                                            ...
                                                            if ret.Success then
                                                                ret := TASTE_BasicTypes.asn1SccT_Boolean_IsConstraintValid(val.a2_started);
                                                                if ret.Success then
                                                                        ...
                                                                        if ret.Success then
                                                                            ...
                                                                            if ret.Success then
                                                                                ...
                                                                                if ret.Success then
                                                                                    ...
                                                                                    if ret.Success then
                                                                                        ret := TASTE_BasicTypes.asn1SccT_Boolean_IsConstraintValid(val.f1_first_it);
                                                                                        if ret.Success then
                                                                                            ...
                                                                                            if ret.Success then
                                                                                                ...
                                                                                                if ret.Success then
                                                                                                    ...
                                                                                                    if ret.Success then
                                                                                                        ...
                                                                                                        if ret.Success then
                                                                                                            ret := TASTE_BasicTypes.asn1SccT_Boolean_IsConstraintValid(val.f2_first_it);
                                                                                                            if ret.Success then
