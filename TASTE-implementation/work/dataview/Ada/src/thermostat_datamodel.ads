...
ERR_THERMOSTAT_STATES:constant Integer := 519; 
...
ERR_THERMOSTAT_CONTEXT:constant Integer := 575; 
ERR_THERMOSTAT_CONTEXT_STATE_2:constant Integer := 533; 
ERR_THERMOSTAT_CONTEXT_INIT_DONE:constant Integer := 540; 
ERR_THERMOSTAT_CONTEXT_TEMPCELSIUS_2:constant Integer := 554; 
ERR_THERMOSTAT_CONTEXT_HEATERISON_2:constant Integer := 568; 
...
ERR_OBSW_DP_SINGLEDATA_SELECTION_2_2:constant Integer := 582; 
...
ERR_TC_HEATER_COMMAND_SELECTION_2_2:constant Integer := 589; 
...
ERR_TC_SELECTION_2_2:constant Integer := 596; 
