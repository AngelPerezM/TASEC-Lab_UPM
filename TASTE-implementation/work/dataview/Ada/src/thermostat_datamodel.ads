...
ERR_THERMOSTAT_STATES:constant Integer := 393; 
...
ERR_THERMOSTAT_CONTEXT:constant Integer := 449; 
ERR_THERMOSTAT_CONTEXT_STATE_2:constant Integer := 407; 
ERR_THERMOSTAT_CONTEXT_INIT_DONE:constant Integer := 414; 
ERR_THERMOSTAT_CONTEXT_TEMPCELSIUS_2:constant Integer := 428; 
ERR_THERMOSTAT_CONTEXT_HEATERISON_2:constant Integer := 442; 
...
ERR_OBSW_DP_SINGLEDATA_SELECTION_2_2:constant Integer := 456; 
...
ERR_TC_HEATER_COMMAND_SELECTION_2_2:constant Integer := 463; 
...
ERR_TC_SELECTION_2_2:constant Integer := 470; 
