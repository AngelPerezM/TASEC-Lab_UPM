...
ERR_CONTEXT_PT1000SENSORS:constant Integer := 6021; 
ERR_CONTEXT_PT1000SENSORS_VCC_CH_2:constant Integer := 5986; 
ERR_CONTEXT_PT1000SENSORS_CHANNELS_2:constant Integer := 6014; 
