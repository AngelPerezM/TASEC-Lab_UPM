...
ERR_CONTEXT_GPSREADER:constant Integer := 5888; 
ERR_CONTEXT_GPSREADER_MAX_RETRIES_2:constant Integer := 5867; 
ERR_CONTEXT_GPSREADER_WAITING_TIME_PER_RETRY_US_2:constant Integer := 5881; 
