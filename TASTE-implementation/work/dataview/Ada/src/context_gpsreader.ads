...
ERR_CONTEXT_GPSREADER:constant Integer := 8163; 
ERR_CONTEXT_GPSREADER_MAX_RETRIES_2:constant Integer := 8142; 
ERR_CONTEXT_GPSREADER_WAITING_TIME_PER_RETRY_US_2:constant Integer := 8156; 
