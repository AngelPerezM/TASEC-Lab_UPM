...
ERR_SYSTEMHANDLER_STATES:constant Integer := 337; 
...
ERR_SYSTEMHANDLER_CONTEXT:constant Integer := 365; 
ERR_SYSTEMHANDLER_CONTEXT_STATE_2:constant Integer := 351; 
ERR_SYSTEMHANDLER_CONTEXT_INIT_DONE:constant Integer := 358; 
...
ERR_OBSW_DP_SINGLEDATA_SELECTION_2:constant Integer := 372; 
...
ERR_TC_HEATER_COMMAND_SELECTION_2:constant Integer := 379; 
...
ERR_TC_SELECTION_2:constant Integer := 386; 
