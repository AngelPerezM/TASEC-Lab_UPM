...
ERR_SPI_ID:constant Integer := 204; 
ERR_SPI_ID_BUS_2:constant Integer := 183; 
ERR_SPI_ID_CS_2:constant Integer := 197; 
...
ERR_I2C_ID:constant Integer := 239; 
ERR_I2C_ID_BUS_2:constant Integer := 218; 
ERR_I2C_ID_ADDRESS_2:constant Integer := 232; 
...
ERR_PS_RAW_DATA:constant Integer := 1632; 
ERR_PS_RAW_DATA_D1_2:constant Integer := 1611; 
ERR_PS_RAW_DATA_D2_2:constant Integer := 1625; 
...
ERR_TC74S_I2CBUSES:constant Integer := 1191; 
ERR_TC74S_I2CBUSES_ELM_2:constant Integer := 1184; 
...
ERR_PT1000S_CHANNELS:constant Integer := 1254; 
ERR_PT1000S_CHANNELS_ELM_2:constant Integer := 1247; 
...
ERR_PS_PROCESSED_DATA:constant Integer := 1667; 
ERR_PS_PROCESSED_DATA_PRESSURE_2:constant Integer := 1646; 
ERR_PS_PROCESSED_DATA_TEMP_2:constant Integer := 1660; 
...
ERR_DATE_TIME:constant Integer := 7239; 
ERR_DATE_TIME_DAY_2:constant Integer := 7162; 
ERR_DATE_TIME_MONTH_2:constant Integer := 7176; 
ERR_DATE_TIME_YEAR_2:constant Integer := 7190; 
ERR_DATE_TIME_HOUR_2:constant Integer := 7204; 
ERR_DATE_TIME_MINUTE_2:constant Integer := 7218; 
ERR_DATE_TIME_SECOND_2:constant Integer := 7232; 
...
ERR_T_INT16:constant Integer := 127; 
...
ERR_MGT_RAW_DATA:constant Integer := 498; 
ERR_MGT_RAW_DATA_X_AXIS_2:constant Integer := 463; 
ERR_MGT_RAW_DATA_Y_AXIS_2:constant Integer := 477; 
ERR_MGT_RAW_DATA_Z_AXIS_2:constant Integer := 491; 
...
ERR_ACC_RAW_DATA:constant Integer := 596; 
ERR_ACC_RAW_DATA_X_AXIS_2:constant Integer := 561; 
ERR_ACC_RAW_DATA_Y_AXIS_2:constant Integer := 575; 
ERR_ACC_RAW_DATA_Z_AXIS_2:constant Integer := 589; 
...
ERR_GYRO_RAW_DATA:constant Integer := 694; 
ERR_GYRO_RAW_DATA_X_AXIS_2:constant Integer := 659; 
ERR_GYRO_RAW_DATA_Y_AXIS_2:constant Integer := 673; 
ERR_GYRO_RAW_DATA_Z_AXIS_2:constant Integer := 687; 
...
ERR_T_UINT16:constant Integer := 134; 
...
ERR_T_UINT64:constant Integer := 141; 
...
ERR_T_FLOAT:constant Integer := 148; 
...
ERR_MGT_MILLIGAUSS_DATA:constant Integer := 547; 
ERR_MGT_MILLIGAUSS_DATA_X_AXIS_2:constant Integer := 512; 
ERR_MGT_MILLIGAUSS_DATA_Y_AXIS_2:constant Integer := 526; 
ERR_MGT_MILLIGAUSS_DATA_Z_AXIS_2:constant Integer := 540; 
...
ERR_ACC_MILLIG_DATA:constant Integer := 645; 
ERR_ACC_MILLIG_DATA_X_AXIS_2:constant Integer := 610; 
ERR_ACC_MILLIG_DATA_Y_AXIS_2:constant Integer := 624; 
ERR_ACC_MILLIG_DATA_Z_AXIS_2:constant Integer := 638; 
...
ERR_GYRO_MILLIDPS_DATA:constant Integer := 743; 
ERR_GYRO_MILLIDPS_DATA_X_AXIS_2:constant Integer := 708; 
ERR_GYRO_MILLIDPS_DATA_Y_AXIS_2:constant Integer := 722; 
ERR_GYRO_MILLIDPS_DATA_Z_AXIS_2:constant Integer := 736; 
...
ERR_PT1000S_RAW_DATA:constant Integer := 1296; 
ERR_PT1000S_RAW_DATA_ELM:constant Integer := 1289; 
ERR_PT1000S_RAW_DATA_ELM_VCC_VOLTS_2:constant Integer := 1268; 
ERR_PT1000S_RAW_DATA_ELM_PT1000_2:constant Integer := 1282; 
...
ERR_PT1000S_CELSIUS_DATA:constant Integer := 1317; 
ERR_PT1000S_CELSIUS_DATA_ELM_2:constant Integer := 1310; 
...
ERR_PS_CALIBRATION_DATA:constant Integer := 1597; 
ERR_PS_CALIBRATION_DATA_C1_2:constant Integer := 1436; 
ERR_PS_CALIBRATION_DATA_C2_2:constant Integer := 1450; 
ERR_PS_CALIBRATION_DATA_C3_2:constant Integer := 1464; 
ERR_PS_CALIBRATION_DATA_C4_2:constant Integer := 1478; 
ERR_PS_CALIBRATION_DATA_C5_2:constant Integer := 1492; 
ERR_PS_CALIBRATION_DATA_C6_2:constant Integer := 1506; 
ERR_PS_CALIBRATION_DATA_SENS_T1_2:constant Integer := 1520; 
ERR_PS_CALIBRATION_DATA_OFF_T1_2:constant Integer := 1534; 
ERR_PS_CALIBRATION_DATA_TCS_2:constant Integer := 1548; 
ERR_PS_CALIBRATION_DATA_TCO_2:constant Integer := 1562; 
ERR_PS_CALIBRATION_DATA_TREF_2:constant Integer := 1576; 
ERR_PS_CALIBRATION_DATA_TEMP_SENS_2:constant Integer := 1590; 
...
ERR_TC_HEATER:constant Integer := 6665; 
ERR_TC_HEATER_HEATER:constant Integer := 6630; 
ERR_TC_HEATER_COMMAND:constant Integer := 6658; 
ERR_TC_HEATER_COMMAND_POWER_MANUAL_2:constant Integer := 6644; 
ERR_TC_HEATER_COMMAND_MAX_MIN:constant Integer := 6651; 
...
ERR_T_DOUBLE:constant Integer := 155; 
...
ERR_GPS_PVT:constant Integer := 449; 
ERR_GPS_PVT_MODE:constant Integer := 246; 
ERR_GPS_PVT_DATE_AND_TIME_2:constant Integer := 260; 
ERR_GPS_PVT_EPT_2:constant Integer := 274; 
ERR_GPS_PVT_LATITUDE_2:constant Integer := 288; 
ERR_GPS_PVT_EPY_2:constant Integer := 302; 
ERR_GPS_PVT_LONGITUDE_2:constant Integer := 316; 
ERR_GPS_PVT_EPX_2:constant Integer := 330; 
ERR_GPS_PVT_ALTITUDE_2:constant Integer := 344; 
ERR_GPS_PVT_EPV_2:constant Integer := 358; 
ERR_GPS_PVT_COURSE_2:constant Integer := 372; 
ERR_GPS_PVT_EPD_2:constant Integer := 386; 
ERR_GPS_PVT_SPEED_2:constant Integer := 400; 
ERR_GPS_PVT_EPS_2:constant Integer := 414; 
ERR_GPS_PVT_CLIMB_2:constant Integer := 428; 
ERR_GPS_PVT_EPC_2:constant Integer := 442; 
...
ERR_HTL_CONFIG:constant Integer := 2122; 
ERR_HTL_CONFIG_PRESS_5KM_2:constant Integer := 2017; 
ERR_HTL_CONFIG_PRESS_10KM_2:constant Integer := 2031; 
ERR_HTL_CONFIG_PRESS_18KM_2:constant Integer := 2045; 
ERR_HTL_CONFIG_A1_DURATION_EMERGENCY_SECS_2:constant Integer := 2059; 
ERR_HTL_CONFIG_A1_DURATION_MAX_SECS_2:constant Integer := 2073; 
ERR_HTL_CONFIG_A2_DURATION_MAX_SECS_2:constant Integer := 2087; 
ERR_HTL_CONFIG_F1_DURATION_SECS_2:constant Integer := 2101; 
ERR_HTL_CONFIG_F2_DURATION_SECS_2:constant Integer := 2115; 
...
ERR_TC:constant Integer := 6861; 
ERR_TC_HEATER_COMMANDS:constant Integer := 6847; 
ERR_TC_HEATER_COMMANDS_HEATER_OF_HTL_2:constant Integer := 6714; 
ERR_TC_HEATER_COMMANDS_CONFIG_OF_HTL_2:constant Integer := 6840; 
ERR_TC_SYSTEM_COMMANDS:constant Integer := 6854; 
...
ERR_FILE_NAME:constant Integer := 162; 
...
ERR_CONTENT_VALIDITY:constant Integer := 169; 
...
ERR_IMU_ALL_DATA:constant Integer := 1170; 
ERR_IMU_ALL_DATA_MGT_RAW_2:constant Integer := 799; 
ERR_IMU_ALL_DATA_MGT_MGAUSS_2:constant Integer := 855; 
ERR_IMU_ALL_DATA_ACCEL_RAW_2:constant Integer := 911; 
ERR_IMU_ALL_DATA_ACCEL_MG_2:constant Integer := 967; 
ERR_IMU_ALL_DATA_GYRO_RAW_2:constant Integer := 1023; 
ERR_IMU_ALL_DATA_GYRO_MDPS_2:constant Integer := 1079; 
ERR_IMU_ALL_DATA_TEMP_RAW_2:constant Integer := 1093; 
ERR_IMU_ALL_DATA_TEMP_CELSIUS_2:constant Integer := 1107; 
ERR_IMU_ALL_DATA_MGT_VALID_2:constant Integer := 1121; 
ERR_IMU_ALL_DATA_ACC_VALID_2:constant Integer := 1135; 
ERR_IMU_ALL_DATA_GYRO_VALID_2:constant Integer := 1149; 
ERR_IMU_ALL_DATA_TEMP_VALID_2:constant Integer := 1163; 
...
ERR_TC74S_ALL_DATA:constant Integer := 1233; 
ERR_TC74S_ALL_DATA_ELM:constant Integer := 1226; 
ERR_TC74S_ALL_DATA_ELM_TEMPERATURE_2:constant Integer := 1205; 
ERR_TC74S_ALL_DATA_ELM_VALIDITY_2:constant Integer := 1219; 
...
ERR_PT1000S_ALL_DATA:constant Integer := 1422; 
ERR_PT1000S_ALL_DATA_RAW_2:constant Integer := 1366; 
ERR_PT1000S_ALL_DATA_CELSIUS_2:constant Integer := 1394; 
ERR_PT1000S_ALL_DATA_VALIDITY:constant Integer := 1415; 
ERR_PT1000S_ALL_DATA_VALIDITY_ELM_2:constant Integer := 1408; 
...
ERR_PS_ALL_DATA:constant Integer := 1954; 
ERR_PS_ALL_DATA_CALIB_2:constant Integer := 1849; 
ERR_PS_ALL_DATA_RAW_2:constant Integer := 1891; 
ERR_PS_ALL_DATA_PROCESSED_2:constant Integer := 1933; 
ERR_PS_ALL_DATA_VALIDITY_2:constant Integer := 1947; 
...
ERR_HEATER_DATA:constant Integer := 1989; 
ERR_HEATER_DATA_POWER_WATTS_2:constant Integer := 1968; 
ERR_HEATER_DATA_VALIDITY_2:constant Integer := 1982; 
...
ERR_OBSW_DP_DATA:constant Integer := 3942; 
ERR_OBSW_DP_DATA_GPS:constant Integer := 2374; 
ERR_OBSW_DP_DATA_GPS_DATA_2:constant Integer := 2339; 
ERR_OBSW_DP_DATA_GPS_GPS_TIME_2:constant Integer := 2353; 
ERR_OBSW_DP_DATA_GPS_MISSION_TIME_2:constant Integer := 2367; 
ERR_OBSW_DP_DATA_IMU:constant Integer := 2843; 
ERR_OBSW_DP_DATA_IMU_DATA_2:constant Integer := 2808; 
ERR_OBSW_DP_DATA_IMU_GPS_TIME_2:constant Integer := 2822; 
ERR_OBSW_DP_DATA_IMU_MISSION_TIME_2:constant Integer := 2836; 
ERR_OBSW_DP_DATA_TC74S:constant Integer := 2927; 
ERR_OBSW_DP_DATA_TC74S_DATA_2:constant Integer := 2892; 
ERR_OBSW_DP_DATA_TC74S_GPS_TIME_2:constant Integer := 2906; 
ERR_OBSW_DP_DATA_TC74S_MISSION_TIME_2:constant Integer := 2920; 
ERR_OBSW_DP_DATA_PT1000S:constant Integer := 3074; 
ERR_OBSW_DP_DATA_PT1000S_DATA_2:constant Integer := 3039; 
ERR_OBSW_DP_DATA_PT1000S_GPS_TIME_2:constant Integer := 3053; 
ERR_OBSW_DP_DATA_PT1000S_MISSION_TIME_2:constant Integer := 3067; 
ERR_OBSW_DP_DATA_PS1:constant Integer := 3403; 
ERR_OBSW_DP_DATA_PS1_DATA_2:constant Integer := 3368; 
ERR_OBSW_DP_DATA_PS1_GPS_TIME_2:constant Integer := 3382; 
ERR_OBSW_DP_DATA_PS1_MISSION_TIME_2:constant Integer := 3396; 
ERR_OBSW_DP_DATA_PS2:constant Integer := 3732; 
ERR_OBSW_DP_DATA_PS2_DATA_2:constant Integer := 3697; 
ERR_OBSW_DP_DATA_PS2_GPS_TIME_2:constant Integer := 3711; 
ERR_OBSW_DP_DATA_PS2_MISSION_TIME_2:constant Integer := 3725; 
ERR_OBSW_DP_DATA_HEATER1:constant Integer := 3809; 
ERR_OBSW_DP_DATA_HEATER1_DATA_2:constant Integer := 3774; 
ERR_OBSW_DP_DATA_HEATER1_GPS_TIME_2:constant Integer := 3788; 
ERR_OBSW_DP_DATA_HEATER1_MISSION_TIME_2:constant Integer := 3802; 
ERR_OBSW_DP_DATA_HEATER2:constant Integer := 3886; 
ERR_OBSW_DP_DATA_HEATER2_DATA_2:constant Integer := 3851; 
ERR_OBSW_DP_DATA_HEATER2_GPS_TIME_2:constant Integer := 3865; 
ERR_OBSW_DP_DATA_HEATER2_MISSION_TIME_2:constant Integer := 3879; 
ERR_OBSW_DP_DATA_ANEMOMETER:constant Integer := 3935; 
ERR_OBSW_DP_DATA_ANEMOMETER_DATA_2:constant Integer := 3900; 
ERR_OBSW_DP_DATA_ANEMOMETER_GPS_TIME_2:constant Integer := 3914; 
ERR_OBSW_DP_DATA_ANEMOMETER_MISSION_TIME_2:constant Integer := 3928; 
...
ERR_OBSW_DP_SINGLEDATA:constant Integer := 5769; 
ERR_OBSW_DP_SINGLEDATA_GPS:constant Integer := 4201; 
ERR_OBSW_DP_SINGLEDATA_GPS_DATA_2:constant Integer := 4166; 
ERR_OBSW_DP_SINGLEDATA_GPS_GPS_TIME_2:constant Integer := 4180; 
ERR_OBSW_DP_SINGLEDATA_GPS_MISSION_TIME_2:constant Integer := 4194; 
ERR_OBSW_DP_SINGLEDATA_IMU:constant Integer := 4670; 
ERR_OBSW_DP_SINGLEDATA_IMU_DATA_2:constant Integer := 4635; 
ERR_OBSW_DP_SINGLEDATA_IMU_GPS_TIME_2:constant Integer := 4649; 
ERR_OBSW_DP_SINGLEDATA_IMU_MISSION_TIME_2:constant Integer := 4663; 
ERR_OBSW_DP_SINGLEDATA_TC74S:constant Integer := 4754; 
ERR_OBSW_DP_SINGLEDATA_TC74S_DATA_2:constant Integer := 4719; 
ERR_OBSW_DP_SINGLEDATA_TC74S_GPS_TIME_2:constant Integer := 4733; 
ERR_OBSW_DP_SINGLEDATA_TC74S_MISSION_TIME_2:constant Integer := 4747; 
ERR_OBSW_DP_SINGLEDATA_PT1000S:constant Integer := 4901; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_DATA_2:constant Integer := 4866; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_GPS_TIME_2:constant Integer := 4880; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_MISSION_TIME_2:constant Integer := 4894; 
ERR_OBSW_DP_SINGLEDATA_PS1:constant Integer := 5230; 
ERR_OBSW_DP_SINGLEDATA_PS1_DATA_2:constant Integer := 5195; 
ERR_OBSW_DP_SINGLEDATA_PS1_GPS_TIME_2:constant Integer := 5209; 
ERR_OBSW_DP_SINGLEDATA_PS1_MISSION_TIME_2:constant Integer := 5223; 
ERR_OBSW_DP_SINGLEDATA_PS2:constant Integer := 5559; 
ERR_OBSW_DP_SINGLEDATA_PS2_DATA_2:constant Integer := 5524; 
ERR_OBSW_DP_SINGLEDATA_PS2_GPS_TIME_2:constant Integer := 5538; 
ERR_OBSW_DP_SINGLEDATA_PS2_MISSION_TIME_2:constant Integer := 5552; 
ERR_OBSW_DP_SINGLEDATA_HEATER1:constant Integer := 5636; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_DATA_2:constant Integer := 5601; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_GPS_TIME_2:constant Integer := 5615; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_MISSION_TIME_2:constant Integer := 5629; 
ERR_OBSW_DP_SINGLEDATA_HEATER2:constant Integer := 5713; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_DATA_2:constant Integer := 5678; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_GPS_TIME_2:constant Integer := 5692; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_MISSION_TIME_2:constant Integer := 5706; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER:constant Integer := 5762; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_DATA_2:constant Integer := 5727; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_GPS_TIME_2:constant Integer := 5741; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_MISSION_TIME_2:constant Integer := 5755; 
...
ERR_ATT_GUI:constant Integer := 7806; 
ERR_ATT_GUI_GPS_2:constant Integer := 7456; 
ERR_ATT_GUI_GPS_DATE_TIME_2:constant Integer := 7554; 
ERR_ATT_GUI_IMU:constant Integer := 7799; 
ERR_ATT_GUI_IMU_MGT_MGAUSS_2:constant Integer := 7610; 
ERR_ATT_GUI_IMU_ACCEL_MG_2:constant Integer := 7666; 
ERR_ATT_GUI_IMU_GYRO_MDPS_2:constant Integer := 7722; 
ERR_ATT_GUI_IMU_TEMP_CELSIUS_2:constant Integer := 7736; 
ERR_ATT_GUI_IMU_MGT_VALID_2:constant Integer := 7750; 
ERR_ATT_GUI_IMU_ACC_VALID_2:constant Integer := 7764; 
ERR_ATT_GUI_IMU_GYRO_VALID_2:constant Integer := 7778; 
ERR_ATT_GUI_IMU_TEMP_VALID_2:constant Integer := 7792; 
...
ERR_PS_GUI:constant Integer := 7855; 
ERR_PS_GUI_PRESSURE_MBAR_2:constant Integer := 7820; 
ERR_PS_GUI_TEMPERATURE_CELSIUS_2:constant Integer := 7834; 
ERR_PS_GUI_VALIDITY_2:constant Integer := 7848; 
...
ERR_ENV_GUI:constant Integer := 8065; 
ERR_ENV_GUI_PRESSURE_SENSOR_1_2:constant Integer := 7911; 
ERR_ENV_GUI_PRESSURE_SENSOR_2_2:constant Integer := 7967; 
ERR_ENV_GUI_ANEMOMETER:constant Integer := 8016; 
ERR_ENV_GUI_ANEMOMETER_GLOBAL_COUNTER_2:constant Integer := 7981; 
ERR_ENV_GUI_ANEMOMETER_TEMPERATURE_CELSIUS_2:constant Integer := 7995; 
ERR_ENV_GUI_ANEMOMETER_TEMPERATURE_VALIDITY_2:constant Integer := 8009; 
ERR_ENV_GUI_HEATER_2:constant Integer := 8058; 
...
ERR_HEATER_ON_OFF:constant Integer := 1996; 
...
ERR_HTL_STATE:constant Integer := 2003; 
...
ERR_TM:constant Integer := 6623; 
ERR_TM_STATE_HTL_2:constant Integer := 5783; 
ERR_TM_HEATER1_2:constant Integer := 5825; 
ERR_TM_HEATER2_2:constant Integer := 5867; 
ERR_TM_TC74S_2:constant Integer := 5916; 
ERR_TM_PT1000S_2:constant Integer := 6028; 
ERR_TM_GPS_2:constant Integer := 6245; 
ERR_TM_IMU:constant Integer := 6490; 
ERR_TM_IMU_MGT_MGAUSS_2:constant Integer := 6301; 
ERR_TM_IMU_ACCEL_MG_2:constant Integer := 6357; 
ERR_TM_IMU_GYRO_MDPS_2:constant Integer := 6413; 
ERR_TM_IMU_TEMP_CELSIUS_2:constant Integer := 6427; 
ERR_TM_IMU_MGT_VALID_2:constant Integer := 6441; 
ERR_TM_IMU_ACC_VALID_2:constant Integer := 6455; 
ERR_TM_IMU_GYRO_VALID_2:constant Integer := 6469; 
ERR_TM_IMU_TEMP_VALID_2:constant Integer := 6483; 
ERR_TM_PS1_2:constant Integer := 6532; 
ERR_TM_PS2_2:constant Integer := 6574; 
ERR_TM_PS1_VALIDITY_2:constant Integer := 6588; 
ERR_TM_PS2_VALIDITY_2:constant Integer := 6602; 
ERR_TM_ANEMOMETER_2:constant Integer := 6616; 
...
ERR_HTL_GUI:constant Integer := 7148; 
ERR_HTL_GUI_STATE_2:constant Integer := 6875; 
ERR_HTL_GUI_HEATER_2:constant Integer := 6917; 
ERR_HTL_GUI_DELTA_T_2:constant Integer := 6931; 
ERR_HTL_GUI_PT1000S:constant Integer := 7043; 
ERR_HTL_GUI_PT1000S_AIRE_ABAJO_2:constant Integer := 6945; 
ERR_HTL_GUI_PT1000S_AIRE_ARRIBA_2:constant Integer := 6959; 
ERR_HTL_GUI_PT1000S_PLACA_ABAJO_2:constant Integer := 6973; 
ERR_HTL_GUI_PT1000S_PLACA_ARRIBA_2:constant Integer := 6987; 
ERR_HTL_GUI_PT1000S_INFINITO_2:constant Integer := 7001; 
ERR_HTL_GUI_PT1000S_EXTERIOR_2:constant Integer := 7015; 
ERR_HTL_GUI_PT1000S_VALIDITY:constant Integer := 7036; 
ERR_HTL_GUI_PT1000S_VALIDITY_ELM_2:constant Integer := 7029; 
ERR_HTL_GUI_TC74S:constant Integer := 7141; 
ERR_HTL_GUI_TC74S_X_POSITIVE_2:constant Integer := 7057; 
ERR_HTL_GUI_TC74S_X_NEGATIVE_2:constant Integer := 7071; 
ERR_HTL_GUI_TC74S_Y_POSITIVE_2:constant Integer := 7085; 
ERR_HTL_GUI_TC74S_Y_NEGATIVE_2:constant Integer := 7099; 
ERR_HTL_GUI_TC74S_Z_TECHO_2:constant Integer := 7113; 
ERR_HTL_GUI_TC74S_VALIDITY:constant Integer := 7134; 
ERR_HTL_GUI_TC74S_VALIDITY_ELM_2:constant Integer := 7127; 
...
ERR_OBSW_DP_FILTER:constant Integer := 3949; 
