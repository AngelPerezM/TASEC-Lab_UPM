...
ERR_SPI_ID:constant Integer := 484; 
ERR_SPI_ID_BUS_2:constant Integer := 463; 
ERR_SPI_ID_CS_2:constant Integer := 477; 
...
ERR_I2C_ID:constant Integer := 519; 
ERR_I2C_ID_BUS_2:constant Integer := 498; 
ERR_I2C_ID_ADDRESS_2:constant Integer := 512; 
...
ERR_PS_RAW_DATA:constant Integer := 1912; 
ERR_PS_RAW_DATA_D1_2:constant Integer := 1891; 
ERR_PS_RAW_DATA_D2_2:constant Integer := 1905; 
...
ERR_TC74S_I2CBUSES:constant Integer := 1471; 
ERR_TC74S_I2CBUSES_ELM_2:constant Integer := 1464; 
...
ERR_PT1000S_CHANNELS:constant Integer := 1534; 
ERR_PT1000S_CHANNELS_ELM_2:constant Integer := 1527; 
...
ERR_PS_PROCESSED_DATA:constant Integer := 1947; 
ERR_PS_PROCESSED_DATA_PRESSURE_2:constant Integer := 1926; 
ERR_PS_PROCESSED_DATA_TEMP_2:constant Integer := 1940; 
...
ERR_DATE_TIME:constant Integer := 7449; 
ERR_DATE_TIME_DAY_2:constant Integer := 7372; 
ERR_DATE_TIME_MONTH_2:constant Integer := 7386; 
ERR_DATE_TIME_YEAR_2:constant Integer := 7400; 
ERR_DATE_TIME_HOUR_2:constant Integer := 7414; 
ERR_DATE_TIME_MINUTE_2:constant Integer := 7428; 
ERR_DATE_TIME_SECOND_2:constant Integer := 7442; 
...
ERR_T_INT16:constant Integer := 407; 
...
ERR_MGT_RAW_DATA:constant Integer := 778; 
ERR_MGT_RAW_DATA_X_AXIS_2:constant Integer := 743; 
ERR_MGT_RAW_DATA_Y_AXIS_2:constant Integer := 757; 
ERR_MGT_RAW_DATA_Z_AXIS_2:constant Integer := 771; 
...
ERR_ACC_RAW_DATA:constant Integer := 876; 
ERR_ACC_RAW_DATA_X_AXIS_2:constant Integer := 841; 
ERR_ACC_RAW_DATA_Y_AXIS_2:constant Integer := 855; 
ERR_ACC_RAW_DATA_Z_AXIS_2:constant Integer := 869; 
...
ERR_GYRO_RAW_DATA:constant Integer := 974; 
ERR_GYRO_RAW_DATA_X_AXIS_2:constant Integer := 939; 
ERR_GYRO_RAW_DATA_Y_AXIS_2:constant Integer := 953; 
ERR_GYRO_RAW_DATA_Z_AXIS_2:constant Integer := 967; 
...
ERR_T_UINT16:constant Integer := 414; 
...
ERR_T_UINT64:constant Integer := 421; 
...
ERR_T_FLOAT:constant Integer := 428; 
...
ERR_MGT_MILLIGAUSS_DATA:constant Integer := 827; 
ERR_MGT_MILLIGAUSS_DATA_X_AXIS_2:constant Integer := 792; 
ERR_MGT_MILLIGAUSS_DATA_Y_AXIS_2:constant Integer := 806; 
ERR_MGT_MILLIGAUSS_DATA_Z_AXIS_2:constant Integer := 820; 
...
ERR_ACC_MILLIG_DATA:constant Integer := 925; 
ERR_ACC_MILLIG_DATA_X_AXIS_2:constant Integer := 890; 
ERR_ACC_MILLIG_DATA_Y_AXIS_2:constant Integer := 904; 
ERR_ACC_MILLIG_DATA_Z_AXIS_2:constant Integer := 918; 
...
ERR_GYRO_MILLIDPS_DATA:constant Integer := 1023; 
ERR_GYRO_MILLIDPS_DATA_X_AXIS_2:constant Integer := 988; 
ERR_GYRO_MILLIDPS_DATA_Y_AXIS_2:constant Integer := 1002; 
ERR_GYRO_MILLIDPS_DATA_Z_AXIS_2:constant Integer := 1016; 
...
ERR_PT1000S_RAW_DATA:constant Integer := 1576; 
ERR_PT1000S_RAW_DATA_ELM:constant Integer := 1569; 
ERR_PT1000S_RAW_DATA_ELM_VCC_VOLTS_2:constant Integer := 1548; 
ERR_PT1000S_RAW_DATA_ELM_PT1000_2:constant Integer := 1562; 
...
ERR_PT1000S_CELSIUS_DATA:constant Integer := 1597; 
ERR_PT1000S_CELSIUS_DATA_ELM_2:constant Integer := 1590; 
...
ERR_PS_CALIBRATION_DATA:constant Integer := 1877; 
ERR_PS_CALIBRATION_DATA_C1_2:constant Integer := 1716; 
ERR_PS_CALIBRATION_DATA_C2_2:constant Integer := 1730; 
ERR_PS_CALIBRATION_DATA_C3_2:constant Integer := 1744; 
ERR_PS_CALIBRATION_DATA_C4_2:constant Integer := 1758; 
ERR_PS_CALIBRATION_DATA_C5_2:constant Integer := 1772; 
ERR_PS_CALIBRATION_DATA_C6_2:constant Integer := 1786; 
ERR_PS_CALIBRATION_DATA_SENS_T1_2:constant Integer := 1800; 
ERR_PS_CALIBRATION_DATA_OFF_T1_2:constant Integer := 1814; 
ERR_PS_CALIBRATION_DATA_TCS_2:constant Integer := 1828; 
ERR_PS_CALIBRATION_DATA_TCO_2:constant Integer := 1842; 
ERR_PS_CALIBRATION_DATA_TREF_2:constant Integer := 1856; 
ERR_PS_CALIBRATION_DATA_TEMP_SENS_2:constant Integer := 1870; 
...
ERR_TC_HEATER:constant Integer := 6945; 
ERR_TC_HEATER_HEATER:constant Integer := 6910; 
ERR_TC_HEATER_COMMAND:constant Integer := 6938; 
ERR_TC_HEATER_COMMAND_POWER_MANUAL_2:constant Integer := 6924; 
ERR_TC_HEATER_COMMAND_MAX_MIN:constant Integer := 6931; 
...
ERR_TC:constant Integer := 7071; 
ERR_TC_HEATER_OF_HTL_2:constant Integer := 6994; 
ERR_TC_TC74S_TEMP_CELSIUS:constant Integer := 7015; 
ERR_TC_TC74S_TEMP_CELSIUS_ELM_2:constant Integer := 7008; 
ERR_TC_PT1000S_TEMP_CELSIUS:constant Integer := 7036; 
ERR_TC_PT1000S_TEMP_CELSIUS_ELM_2:constant Integer := 7029; 
ERR_TC_PRESSURE1_MBAR_2:constant Integer := 7050; 
ERR_TC_PRESSURE2_MBAR_2:constant Integer := 7064; 
...
ERR_T_DOUBLE:constant Integer := 435; 
...
ERR_GPS_PVT:constant Integer := 729; 
ERR_GPS_PVT_MODE:constant Integer := 526; 
ERR_GPS_PVT_DATE_AND_TIME_2:constant Integer := 540; 
ERR_GPS_PVT_EPT_2:constant Integer := 554; 
ERR_GPS_PVT_LATITUDE_2:constant Integer := 568; 
ERR_GPS_PVT_EPY_2:constant Integer := 582; 
ERR_GPS_PVT_LONGITUDE_2:constant Integer := 596; 
ERR_GPS_PVT_EPX_2:constant Integer := 610; 
ERR_GPS_PVT_ALTITUDE_2:constant Integer := 624; 
ERR_GPS_PVT_EPV_2:constant Integer := 638; 
ERR_GPS_PVT_COURSE_2:constant Integer := 652; 
ERR_GPS_PVT_EPD_2:constant Integer := 666; 
ERR_GPS_PVT_SPEED_2:constant Integer := 680; 
ERR_GPS_PVT_EPS_2:constant Integer := 694; 
ERR_GPS_PVT_CLIMB_2:constant Integer := 708; 
ERR_GPS_PVT_EPC_2:constant Integer := 722; 
...
ERR_HTL_CONFIG:constant Integer := 2402; 
ERR_HTL_CONFIG_PRESS_5KM_2:constant Integer := 2297; 
ERR_HTL_CONFIG_PRESS_10KM_2:constant Integer := 2311; 
ERR_HTL_CONFIG_PRESS_18KM_2:constant Integer := 2325; 
ERR_HTL_CONFIG_A1_DURATION_EMERGENCY_SECS_2:constant Integer := 2339; 
ERR_HTL_CONFIG_A1_DURATION_MAX_SECS_2:constant Integer := 2353; 
ERR_HTL_CONFIG_A2_DURATION_MAX_SECS_2:constant Integer := 2367; 
ERR_HTL_CONFIG_F1_DURATION_SECS_2:constant Integer := 2381; 
ERR_HTL_CONFIG_F2_DURATION_SECS_2:constant Integer := 2395; 
...
ERR_FILE_NAME:constant Integer := 442; 
...
ERR_CONTENT_VALIDITY:constant Integer := 449; 
...
ERR_IMU_ALL_DATA:constant Integer := 1450; 
ERR_IMU_ALL_DATA_MGT_RAW_2:constant Integer := 1079; 
ERR_IMU_ALL_DATA_MGT_MGAUSS_2:constant Integer := 1135; 
ERR_IMU_ALL_DATA_ACCEL_RAW_2:constant Integer := 1191; 
ERR_IMU_ALL_DATA_ACCEL_MG_2:constant Integer := 1247; 
ERR_IMU_ALL_DATA_GYRO_RAW_2:constant Integer := 1303; 
ERR_IMU_ALL_DATA_GYRO_MDPS_2:constant Integer := 1359; 
ERR_IMU_ALL_DATA_TEMP_RAW_2:constant Integer := 1373; 
ERR_IMU_ALL_DATA_TEMP_CELSIUS_2:constant Integer := 1387; 
ERR_IMU_ALL_DATA_MGT_VALID_2:constant Integer := 1401; 
ERR_IMU_ALL_DATA_ACC_VALID_2:constant Integer := 1415; 
ERR_IMU_ALL_DATA_GYRO_VALID_2:constant Integer := 1429; 
ERR_IMU_ALL_DATA_TEMP_VALID_2:constant Integer := 1443; 
...
ERR_TC74S_ALL_DATA:constant Integer := 1513; 
ERR_TC74S_ALL_DATA_ELM:constant Integer := 1506; 
ERR_TC74S_ALL_DATA_ELM_TEMPERATURE_2:constant Integer := 1485; 
ERR_TC74S_ALL_DATA_ELM_VALIDITY_2:constant Integer := 1499; 
...
ERR_PT1000S_ALL_DATA:constant Integer := 1702; 
ERR_PT1000S_ALL_DATA_RAW_2:constant Integer := 1646; 
ERR_PT1000S_ALL_DATA_CELSIUS_2:constant Integer := 1674; 
ERR_PT1000S_ALL_DATA_VALIDITY:constant Integer := 1695; 
ERR_PT1000S_ALL_DATA_VALIDITY_ELM_2:constant Integer := 1688; 
...
ERR_PS_ALL_DATA:constant Integer := 2234; 
ERR_PS_ALL_DATA_CALIB_2:constant Integer := 2129; 
ERR_PS_ALL_DATA_RAW_2:constant Integer := 2171; 
ERR_PS_ALL_DATA_PROCESSED_2:constant Integer := 2213; 
ERR_PS_ALL_DATA_VALIDITY_2:constant Integer := 2227; 
...
ERR_HEATER_DATA:constant Integer := 2269; 
ERR_HEATER_DATA_POWER_WATTS_2:constant Integer := 2248; 
ERR_HEATER_DATA_VALIDITY_2:constant Integer := 2262; 
...
ERR_OBSW_DP_DATA:constant Integer := 4222; 
ERR_OBSW_DP_DATA_GPS:constant Integer := 2654; 
ERR_OBSW_DP_DATA_GPS_DATA_2:constant Integer := 2619; 
ERR_OBSW_DP_DATA_GPS_GPS_TIME_2:constant Integer := 2633; 
ERR_OBSW_DP_DATA_GPS_MISSION_TIME_2:constant Integer := 2647; 
ERR_OBSW_DP_DATA_IMU:constant Integer := 3123; 
ERR_OBSW_DP_DATA_IMU_DATA_2:constant Integer := 3088; 
ERR_OBSW_DP_DATA_IMU_GPS_TIME_2:constant Integer := 3102; 
ERR_OBSW_DP_DATA_IMU_MISSION_TIME_2:constant Integer := 3116; 
ERR_OBSW_DP_DATA_TC74S:constant Integer := 3207; 
ERR_OBSW_DP_DATA_TC74S_DATA_2:constant Integer := 3172; 
ERR_OBSW_DP_DATA_TC74S_GPS_TIME_2:constant Integer := 3186; 
ERR_OBSW_DP_DATA_TC74S_MISSION_TIME_2:constant Integer := 3200; 
ERR_OBSW_DP_DATA_PT1000S:constant Integer := 3354; 
ERR_OBSW_DP_DATA_PT1000S_DATA_2:constant Integer := 3319; 
ERR_OBSW_DP_DATA_PT1000S_GPS_TIME_2:constant Integer := 3333; 
ERR_OBSW_DP_DATA_PT1000S_MISSION_TIME_2:constant Integer := 3347; 
ERR_OBSW_DP_DATA_PS1:constant Integer := 3683; 
ERR_OBSW_DP_DATA_PS1_DATA_2:constant Integer := 3648; 
ERR_OBSW_DP_DATA_PS1_GPS_TIME_2:constant Integer := 3662; 
ERR_OBSW_DP_DATA_PS1_MISSION_TIME_2:constant Integer := 3676; 
ERR_OBSW_DP_DATA_PS2:constant Integer := 4012; 
ERR_OBSW_DP_DATA_PS2_DATA_2:constant Integer := 3977; 
ERR_OBSW_DP_DATA_PS2_GPS_TIME_2:constant Integer := 3991; 
ERR_OBSW_DP_DATA_PS2_MISSION_TIME_2:constant Integer := 4005; 
ERR_OBSW_DP_DATA_HEATER1:constant Integer := 4089; 
ERR_OBSW_DP_DATA_HEATER1_DATA_2:constant Integer := 4054; 
ERR_OBSW_DP_DATA_HEATER1_GPS_TIME_2:constant Integer := 4068; 
ERR_OBSW_DP_DATA_HEATER1_MISSION_TIME_2:constant Integer := 4082; 
ERR_OBSW_DP_DATA_HEATER2:constant Integer := 4166; 
ERR_OBSW_DP_DATA_HEATER2_DATA_2:constant Integer := 4131; 
ERR_OBSW_DP_DATA_HEATER2_GPS_TIME_2:constant Integer := 4145; 
ERR_OBSW_DP_DATA_HEATER2_MISSION_TIME_2:constant Integer := 4159; 
ERR_OBSW_DP_DATA_ANEMOMETER:constant Integer := 4215; 
ERR_OBSW_DP_DATA_ANEMOMETER_DATA_2:constant Integer := 4180; 
ERR_OBSW_DP_DATA_ANEMOMETER_GPS_TIME_2:constant Integer := 4194; 
ERR_OBSW_DP_DATA_ANEMOMETER_MISSION_TIME_2:constant Integer := 4208; 
...
ERR_OBSW_DP_SINGLEDATA:constant Integer := 6049; 
ERR_OBSW_DP_SINGLEDATA_GPS:constant Integer := 4481; 
ERR_OBSW_DP_SINGLEDATA_GPS_DATA_2:constant Integer := 4446; 
ERR_OBSW_DP_SINGLEDATA_GPS_GPS_TIME_2:constant Integer := 4460; 
ERR_OBSW_DP_SINGLEDATA_GPS_MISSION_TIME_2:constant Integer := 4474; 
ERR_OBSW_DP_SINGLEDATA_IMU:constant Integer := 4950; 
ERR_OBSW_DP_SINGLEDATA_IMU_DATA_2:constant Integer := 4915; 
ERR_OBSW_DP_SINGLEDATA_IMU_GPS_TIME_2:constant Integer := 4929; 
ERR_OBSW_DP_SINGLEDATA_IMU_MISSION_TIME_2:constant Integer := 4943; 
ERR_OBSW_DP_SINGLEDATA_TC74S:constant Integer := 5034; 
ERR_OBSW_DP_SINGLEDATA_TC74S_DATA_2:constant Integer := 4999; 
ERR_OBSW_DP_SINGLEDATA_TC74S_GPS_TIME_2:constant Integer := 5013; 
ERR_OBSW_DP_SINGLEDATA_TC74S_MISSION_TIME_2:constant Integer := 5027; 
ERR_OBSW_DP_SINGLEDATA_PT1000S:constant Integer := 5181; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_DATA_2:constant Integer := 5146; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_GPS_TIME_2:constant Integer := 5160; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_MISSION_TIME_2:constant Integer := 5174; 
ERR_OBSW_DP_SINGLEDATA_PS1:constant Integer := 5510; 
ERR_OBSW_DP_SINGLEDATA_PS1_DATA_2:constant Integer := 5475; 
ERR_OBSW_DP_SINGLEDATA_PS1_GPS_TIME_2:constant Integer := 5489; 
ERR_OBSW_DP_SINGLEDATA_PS1_MISSION_TIME_2:constant Integer := 5503; 
ERR_OBSW_DP_SINGLEDATA_PS2:constant Integer := 5839; 
ERR_OBSW_DP_SINGLEDATA_PS2_DATA_2:constant Integer := 5804; 
ERR_OBSW_DP_SINGLEDATA_PS2_GPS_TIME_2:constant Integer := 5818; 
ERR_OBSW_DP_SINGLEDATA_PS2_MISSION_TIME_2:constant Integer := 5832; 
ERR_OBSW_DP_SINGLEDATA_HEATER1:constant Integer := 5916; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_DATA_2:constant Integer := 5881; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_GPS_TIME_2:constant Integer := 5895; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_MISSION_TIME_2:constant Integer := 5909; 
ERR_OBSW_DP_SINGLEDATA_HEATER2:constant Integer := 5993; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_DATA_2:constant Integer := 5958; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_GPS_TIME_2:constant Integer := 5972; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_MISSION_TIME_2:constant Integer := 5986; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER:constant Integer := 6042; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_DATA_2:constant Integer := 6007; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_GPS_TIME_2:constant Integer := 6021; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_MISSION_TIME_2:constant Integer := 6035; 
...
ERR_ATT_GUI:constant Integer := 8016; 
ERR_ATT_GUI_GPS_2:constant Integer := 7666; 
ERR_ATT_GUI_GPS_DATE_TIME_2:constant Integer := 7764; 
ERR_ATT_GUI_IMU:constant Integer := 8009; 
ERR_ATT_GUI_IMU_MGT_MGAUSS_2:constant Integer := 7820; 
ERR_ATT_GUI_IMU_ACCEL_MG_2:constant Integer := 7876; 
ERR_ATT_GUI_IMU_GYRO_MDPS_2:constant Integer := 7932; 
ERR_ATT_GUI_IMU_TEMP_CELSIUS_2:constant Integer := 7946; 
ERR_ATT_GUI_IMU_MGT_VALID_2:constant Integer := 7960; 
ERR_ATT_GUI_IMU_ACC_VALID_2:constant Integer := 7974; 
ERR_ATT_GUI_IMU_GYRO_VALID_2:constant Integer := 7988; 
ERR_ATT_GUI_IMU_TEMP_VALID_2:constant Integer := 8002; 
...
ERR_PS_GUI:constant Integer := 8065; 
ERR_PS_GUI_PRESSURE_MBAR_2:constant Integer := 8030; 
ERR_PS_GUI_TEMPERATURE_CELSIUS_2:constant Integer := 8044; 
ERR_PS_GUI_VALIDITY_2:constant Integer := 8058; 
...
ERR_ENV_GUI:constant Integer := 8275; 
ERR_ENV_GUI_PRESSURE_SENSOR_1_2:constant Integer := 8121; 
ERR_ENV_GUI_PRESSURE_SENSOR_2_2:constant Integer := 8177; 
ERR_ENV_GUI_ANEMOMETER:constant Integer := 8226; 
ERR_ENV_GUI_ANEMOMETER_GLOBAL_COUNTER_2:constant Integer := 8191; 
ERR_ENV_GUI_ANEMOMETER_TEMPERATURE_CELSIUS_2:constant Integer := 8205; 
ERR_ENV_GUI_ANEMOMETER_TEMPERATURE_VALIDITY_2:constant Integer := 8219; 
ERR_ENV_GUI_HEATER_2:constant Integer := 8268; 
...
ERR_HEATER_ON_OFF:constant Integer := 2276; 
...
ERR_HTL_STATE:constant Integer := 2283; 
...
ERR_TM:constant Integer := 6903; 
ERR_TM_STATE_HTL_2:constant Integer := 6063; 
ERR_TM_HEATER1_2:constant Integer := 6105; 
ERR_TM_HEATER2_2:constant Integer := 6147; 
ERR_TM_TC74S_2:constant Integer := 6196; 
ERR_TM_PT1000S_2:constant Integer := 6308; 
ERR_TM_GPS_2:constant Integer := 6525; 
ERR_TM_IMU:constant Integer := 6770; 
ERR_TM_IMU_MGT_MGAUSS_2:constant Integer := 6581; 
ERR_TM_IMU_ACCEL_MG_2:constant Integer := 6637; 
ERR_TM_IMU_GYRO_MDPS_2:constant Integer := 6693; 
ERR_TM_IMU_TEMP_CELSIUS_2:constant Integer := 6707; 
ERR_TM_IMU_MGT_VALID_2:constant Integer := 6721; 
ERR_TM_IMU_ACC_VALID_2:constant Integer := 6735; 
ERR_TM_IMU_GYRO_VALID_2:constant Integer := 6749; 
ERR_TM_IMU_TEMP_VALID_2:constant Integer := 6763; 
ERR_TM_PS1_2:constant Integer := 6812; 
ERR_TM_PS2_2:constant Integer := 6854; 
ERR_TM_PS1_VALIDITY_2:constant Integer := 6868; 
ERR_TM_PS2_VALIDITY_2:constant Integer := 6882; 
ERR_TM_ANEMOMETER_2:constant Integer := 6896; 
...
ERR_HTL_GUI:constant Integer := 7358; 
ERR_HTL_GUI_STATE_2:constant Integer := 7085; 
ERR_HTL_GUI_HEATER_2:constant Integer := 7127; 
ERR_HTL_GUI_DELTA_T_2:constant Integer := 7141; 
ERR_HTL_GUI_PT1000S:constant Integer := 7253; 
ERR_HTL_GUI_PT1000S_AIRE_ABAJO_2:constant Integer := 7155; 
ERR_HTL_GUI_PT1000S_AIRE_ARRIBA_2:constant Integer := 7169; 
ERR_HTL_GUI_PT1000S_PLACA_ABAJO_2:constant Integer := 7183; 
ERR_HTL_GUI_PT1000S_PLACA_ARRIBA_2:constant Integer := 7197; 
ERR_HTL_GUI_PT1000S_INFINITO_2:constant Integer := 7211; 
ERR_HTL_GUI_PT1000S_EXTERIOR_2:constant Integer := 7225; 
ERR_HTL_GUI_PT1000S_VALIDITY:constant Integer := 7246; 
ERR_HTL_GUI_PT1000S_VALIDITY_ELM_2:constant Integer := 7239; 
ERR_HTL_GUI_TC74S:constant Integer := 7351; 
ERR_HTL_GUI_TC74S_X_POSITIVE_2:constant Integer := 7267; 
ERR_HTL_GUI_TC74S_X_NEGATIVE_2:constant Integer := 7281; 
ERR_HTL_GUI_TC74S_Y_POSITIVE_2:constant Integer := 7295; 
ERR_HTL_GUI_TC74S_Y_NEGATIVE_2:constant Integer := 7309; 
ERR_HTL_GUI_TC74S_Z_TECHO_2:constant Integer := 7323; 
ERR_HTL_GUI_TC74S_VALIDITY:constant Integer := 7344; 
ERR_HTL_GUI_TC74S_VALIDITY_ELM_2:constant Integer := 7337; 
...
ERR_OBSW_DP_FILTER:constant Integer := 4229; 
