...
ERR_SPI_ID:constant Integer := 554; 
ERR_SPI_ID_BUS_2:constant Integer := 533; 
ERR_SPI_ID_CS_2:constant Integer := 547; 
...
ERR_I2C_ID:constant Integer := 589; 
ERR_I2C_ID_BUS_2:constant Integer := 568; 
ERR_I2C_ID_ADDRESS_2:constant Integer := 582; 
...
ERR_PS_RAW_DATA:constant Integer := 1982; 
ERR_PS_RAW_DATA_D1_2:constant Integer := 1961; 
ERR_PS_RAW_DATA_D2_2:constant Integer := 1975; 
...
ERR_TC74S_I2CBUSES:constant Integer := 1541; 
ERR_TC74S_I2CBUSES_ELM_2:constant Integer := 1534; 
...
ERR_PT1000S_CHANNELS:constant Integer := 1604; 
ERR_PT1000S_CHANNELS_ELM_2:constant Integer := 1597; 
...
ERR_PS_PROCESSED_DATA:constant Integer := 2017; 
ERR_PS_PROCESSED_DATA_PRESSURE_2:constant Integer := 1996; 
ERR_PS_PROCESSED_DATA_TEMP_2:constant Integer := 2010; 
...
ERR_T_INT16:constant Integer := 477; 
...
ERR_MGT_RAW_DATA:constant Integer := 848; 
ERR_MGT_RAW_DATA_X_AXIS_2:constant Integer := 813; 
ERR_MGT_RAW_DATA_Y_AXIS_2:constant Integer := 827; 
ERR_MGT_RAW_DATA_Z_AXIS_2:constant Integer := 841; 
...
ERR_ACC_RAW_DATA:constant Integer := 946; 
ERR_ACC_RAW_DATA_X_AXIS_2:constant Integer := 911; 
ERR_ACC_RAW_DATA_Y_AXIS_2:constant Integer := 925; 
ERR_ACC_RAW_DATA_Z_AXIS_2:constant Integer := 939; 
...
ERR_GYRO_RAW_DATA:constant Integer := 1044; 
ERR_GYRO_RAW_DATA_X_AXIS_2:constant Integer := 1009; 
ERR_GYRO_RAW_DATA_Y_AXIS_2:constant Integer := 1023; 
ERR_GYRO_RAW_DATA_Z_AXIS_2:constant Integer := 1037; 
...
ERR_T_UINT16:constant Integer := 484; 
...
ERR_T_UINT64:constant Integer := 491; 
...
ERR_T_FLOAT:constant Integer := 498; 
...
ERR_MGT_MILLIGAUSS_DATA:constant Integer := 897; 
ERR_MGT_MILLIGAUSS_DATA_X_AXIS_2:constant Integer := 862; 
ERR_MGT_MILLIGAUSS_DATA_Y_AXIS_2:constant Integer := 876; 
ERR_MGT_MILLIGAUSS_DATA_Z_AXIS_2:constant Integer := 890; 
...
ERR_ACC_MILLIG_DATA:constant Integer := 995; 
ERR_ACC_MILLIG_DATA_X_AXIS_2:constant Integer := 960; 
ERR_ACC_MILLIG_DATA_Y_AXIS_2:constant Integer := 974; 
ERR_ACC_MILLIG_DATA_Z_AXIS_2:constant Integer := 988; 
...
ERR_GYRO_MILLIDPS_DATA:constant Integer := 1093; 
ERR_GYRO_MILLIDPS_DATA_X_AXIS_2:constant Integer := 1058; 
ERR_GYRO_MILLIDPS_DATA_Y_AXIS_2:constant Integer := 1072; 
ERR_GYRO_MILLIDPS_DATA_Z_AXIS_2:constant Integer := 1086; 
...
ERR_PT1000S_RAW_DATA:constant Integer := 1646; 
ERR_PT1000S_RAW_DATA_ELM:constant Integer := 1639; 
ERR_PT1000S_RAW_DATA_ELM_VCC_VOLTS_2:constant Integer := 1618; 
ERR_PT1000S_RAW_DATA_ELM_PT1000_2:constant Integer := 1632; 
...
ERR_PT1000S_CELSIUS_DATA:constant Integer := 1667; 
ERR_PT1000S_CELSIUS_DATA_ELM_2:constant Integer := 1660; 
...
ERR_PS_CALIBRATION_DATA:constant Integer := 1947; 
ERR_PS_CALIBRATION_DATA_C1_2:constant Integer := 1786; 
ERR_PS_CALIBRATION_DATA_C2_2:constant Integer := 1800; 
ERR_PS_CALIBRATION_DATA_C3_2:constant Integer := 1814; 
ERR_PS_CALIBRATION_DATA_C4_2:constant Integer := 1828; 
ERR_PS_CALIBRATION_DATA_C5_2:constant Integer := 1842; 
ERR_PS_CALIBRATION_DATA_C6_2:constant Integer := 1856; 
ERR_PS_CALIBRATION_DATA_SENS_T1_2:constant Integer := 1870; 
ERR_PS_CALIBRATION_DATA_OFF_T1_2:constant Integer := 1884; 
ERR_PS_CALIBRATION_DATA_TCS_2:constant Integer := 1898; 
ERR_PS_CALIBRATION_DATA_TCO_2:constant Integer := 1912; 
ERR_PS_CALIBRATION_DATA_TREF_2:constant Integer := 1926; 
ERR_PS_CALIBRATION_DATA_TEMP_SENS_2:constant Integer := 1940; 
...
ERR_T_DOUBLE:constant Integer := 505; 
...
ERR_GPS_PVT:constant Integer := 799; 
ERR_GPS_PVT_MODE:constant Integer := 596; 
ERR_GPS_PVT_DATE_AND_TIME_2:constant Integer := 610; 
ERR_GPS_PVT_EPT_2:constant Integer := 624; 
ERR_GPS_PVT_LATITUDE_2:constant Integer := 638; 
ERR_GPS_PVT_EPY_2:constant Integer := 652; 
ERR_GPS_PVT_LONGITUDE_2:constant Integer := 666; 
ERR_GPS_PVT_EPX_2:constant Integer := 680; 
ERR_GPS_PVT_ALTITUDE_2:constant Integer := 694; 
ERR_GPS_PVT_EPV_2:constant Integer := 708; 
ERR_GPS_PVT_COURSE_2:constant Integer := 722; 
ERR_GPS_PVT_EPD_2:constant Integer := 736; 
ERR_GPS_PVT_SPEED_2:constant Integer := 750; 
ERR_GPS_PVT_EPS_2:constant Integer := 764; 
ERR_GPS_PVT_CLIMB_2:constant Integer := 778; 
ERR_GPS_PVT_EPC_2:constant Integer := 792; 
...
ERR_HTL_CONFIG:constant Integer := 2472; 
ERR_HTL_CONFIG_PRESS_5KM_2:constant Integer := 2367; 
ERR_HTL_CONFIG_PRESS_10KM_2:constant Integer := 2381; 
ERR_HTL_CONFIG_PRESS_18KM_2:constant Integer := 2395; 
ERR_HTL_CONFIG_A1_DURATION_EMERGENCY_SECS_2:constant Integer := 2409; 
ERR_HTL_CONFIG_A1_DURATION_MAX_SECS_2:constant Integer := 2423; 
ERR_HTL_CONFIG_A2_DURATION_MAX_SECS_2:constant Integer := 2437; 
ERR_HTL_CONFIG_F1_DURATION_SECS_2:constant Integer := 2451; 
ERR_HTL_CONFIG_F2_DURATION_SECS_2:constant Integer := 2465; 
...
ERR_FILE_NAME:constant Integer := 512; 
...
ERR_CONTENT_VALIDITY:constant Integer := 519; 
...
ERR_IMU_ALL_DATA:constant Integer := 1520; 
ERR_IMU_ALL_DATA_MGT_RAW_2:constant Integer := 1149; 
ERR_IMU_ALL_DATA_MGT_MGAUSS_2:constant Integer := 1205; 
ERR_IMU_ALL_DATA_ACCEL_RAW_2:constant Integer := 1261; 
ERR_IMU_ALL_DATA_ACCEL_MG_2:constant Integer := 1317; 
ERR_IMU_ALL_DATA_GYRO_RAW_2:constant Integer := 1373; 
ERR_IMU_ALL_DATA_GYRO_MDPS_2:constant Integer := 1429; 
ERR_IMU_ALL_DATA_TEMP_RAW_2:constant Integer := 1443; 
ERR_IMU_ALL_DATA_TEMP_CELSIUS_2:constant Integer := 1457; 
ERR_IMU_ALL_DATA_MGT_VALID_2:constant Integer := 1471; 
ERR_IMU_ALL_DATA_ACC_VALID_2:constant Integer := 1485; 
ERR_IMU_ALL_DATA_GYRO_VALID_2:constant Integer := 1499; 
ERR_IMU_ALL_DATA_TEMP_VALID_2:constant Integer := 1513; 
...
ERR_TC74S_ALL_DATA:constant Integer := 1583; 
ERR_TC74S_ALL_DATA_ELM:constant Integer := 1576; 
ERR_TC74S_ALL_DATA_ELM_TEMPERATURE_2:constant Integer := 1555; 
ERR_TC74S_ALL_DATA_ELM_VALIDITY_2:constant Integer := 1569; 
...
ERR_PT1000S_ALL_DATA:constant Integer := 1772; 
ERR_PT1000S_ALL_DATA_RAW_2:constant Integer := 1716; 
ERR_PT1000S_ALL_DATA_CELSIUS_2:constant Integer := 1744; 
ERR_PT1000S_ALL_DATA_VALIDITY:constant Integer := 1765; 
ERR_PT1000S_ALL_DATA_VALIDITY_ELM_2:constant Integer := 1758; 
...
ERR_PS_ALL_DATA:constant Integer := 2304; 
ERR_PS_ALL_DATA_CALIB_2:constant Integer := 2199; 
ERR_PS_ALL_DATA_RAW_2:constant Integer := 2241; 
ERR_PS_ALL_DATA_PROCESSED_2:constant Integer := 2283; 
ERR_PS_ALL_DATA_VALIDITY_2:constant Integer := 2297; 
...
ERR_HEATER_DATA:constant Integer := 2339; 
ERR_HEATER_DATA_POWER_WATTS_2:constant Integer := 2318; 
ERR_HEATER_DATA_VALIDITY_2:constant Integer := 2332; 
...
ERR_OBSW_DP_DATA:constant Integer := 4292; 
ERR_OBSW_DP_DATA_GPS:constant Integer := 2724; 
ERR_OBSW_DP_DATA_GPS_DATA_2:constant Integer := 2689; 
ERR_OBSW_DP_DATA_GPS_GPS_TIME_2:constant Integer := 2703; 
ERR_OBSW_DP_DATA_GPS_MISSION_TIME_2:constant Integer := 2717; 
ERR_OBSW_DP_DATA_IMU:constant Integer := 3193; 
ERR_OBSW_DP_DATA_IMU_DATA_2:constant Integer := 3158; 
ERR_OBSW_DP_DATA_IMU_GPS_TIME_2:constant Integer := 3172; 
ERR_OBSW_DP_DATA_IMU_MISSION_TIME_2:constant Integer := 3186; 
ERR_OBSW_DP_DATA_TC74S:constant Integer := 3277; 
ERR_OBSW_DP_DATA_TC74S_DATA_2:constant Integer := 3242; 
ERR_OBSW_DP_DATA_TC74S_GPS_TIME_2:constant Integer := 3256; 
ERR_OBSW_DP_DATA_TC74S_MISSION_TIME_2:constant Integer := 3270; 
ERR_OBSW_DP_DATA_PT1000S:constant Integer := 3424; 
ERR_OBSW_DP_DATA_PT1000S_DATA_2:constant Integer := 3389; 
ERR_OBSW_DP_DATA_PT1000S_GPS_TIME_2:constant Integer := 3403; 
ERR_OBSW_DP_DATA_PT1000S_MISSION_TIME_2:constant Integer := 3417; 
ERR_OBSW_DP_DATA_PS1:constant Integer := 3753; 
ERR_OBSW_DP_DATA_PS1_DATA_2:constant Integer := 3718; 
ERR_OBSW_DP_DATA_PS1_GPS_TIME_2:constant Integer := 3732; 
ERR_OBSW_DP_DATA_PS1_MISSION_TIME_2:constant Integer := 3746; 
ERR_OBSW_DP_DATA_PS2:constant Integer := 4082; 
ERR_OBSW_DP_DATA_PS2_DATA_2:constant Integer := 4047; 
ERR_OBSW_DP_DATA_PS2_GPS_TIME_2:constant Integer := 4061; 
ERR_OBSW_DP_DATA_PS2_MISSION_TIME_2:constant Integer := 4075; 
ERR_OBSW_DP_DATA_HEATER1:constant Integer := 4159; 
ERR_OBSW_DP_DATA_HEATER1_DATA_2:constant Integer := 4124; 
ERR_OBSW_DP_DATA_HEATER1_GPS_TIME_2:constant Integer := 4138; 
ERR_OBSW_DP_DATA_HEATER1_MISSION_TIME_2:constant Integer := 4152; 
ERR_OBSW_DP_DATA_HEATER2:constant Integer := 4236; 
ERR_OBSW_DP_DATA_HEATER2_DATA_2:constant Integer := 4201; 
ERR_OBSW_DP_DATA_HEATER2_GPS_TIME_2:constant Integer := 4215; 
ERR_OBSW_DP_DATA_HEATER2_MISSION_TIME_2:constant Integer := 4229; 
ERR_OBSW_DP_DATA_ANEMOMETER:constant Integer := 4285; 
ERR_OBSW_DP_DATA_ANEMOMETER_DATA_2:constant Integer := 4250; 
ERR_OBSW_DP_DATA_ANEMOMETER_GPS_TIME_2:constant Integer := 4264; 
ERR_OBSW_DP_DATA_ANEMOMETER_MISSION_TIME_2:constant Integer := 4278; 
...
ERR_OBSW_DP_SINGLEDATA:constant Integer := 6119; 
ERR_OBSW_DP_SINGLEDATA_GPS:constant Integer := 4551; 
ERR_OBSW_DP_SINGLEDATA_GPS_DATA_2:constant Integer := 4516; 
ERR_OBSW_DP_SINGLEDATA_GPS_GPS_TIME_2:constant Integer := 4530; 
ERR_OBSW_DP_SINGLEDATA_GPS_MISSION_TIME_2:constant Integer := 4544; 
ERR_OBSW_DP_SINGLEDATA_IMU:constant Integer := 5020; 
ERR_OBSW_DP_SINGLEDATA_IMU_DATA_2:constant Integer := 4985; 
ERR_OBSW_DP_SINGLEDATA_IMU_GPS_TIME_2:constant Integer := 4999; 
ERR_OBSW_DP_SINGLEDATA_IMU_MISSION_TIME_2:constant Integer := 5013; 
ERR_OBSW_DP_SINGLEDATA_TC74S:constant Integer := 5104; 
ERR_OBSW_DP_SINGLEDATA_TC74S_DATA_2:constant Integer := 5069; 
ERR_OBSW_DP_SINGLEDATA_TC74S_GPS_TIME_2:constant Integer := 5083; 
ERR_OBSW_DP_SINGLEDATA_TC74S_MISSION_TIME_2:constant Integer := 5097; 
ERR_OBSW_DP_SINGLEDATA_PT1000S:constant Integer := 5251; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_DATA_2:constant Integer := 5216; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_GPS_TIME_2:constant Integer := 5230; 
ERR_OBSW_DP_SINGLEDATA_PT1000S_MISSION_TIME_2:constant Integer := 5244; 
ERR_OBSW_DP_SINGLEDATA_PS1:constant Integer := 5580; 
ERR_OBSW_DP_SINGLEDATA_PS1_DATA_2:constant Integer := 5545; 
ERR_OBSW_DP_SINGLEDATA_PS1_GPS_TIME_2:constant Integer := 5559; 
ERR_OBSW_DP_SINGLEDATA_PS1_MISSION_TIME_2:constant Integer := 5573; 
ERR_OBSW_DP_SINGLEDATA_PS2:constant Integer := 5909; 
ERR_OBSW_DP_SINGLEDATA_PS2_DATA_2:constant Integer := 5874; 
ERR_OBSW_DP_SINGLEDATA_PS2_GPS_TIME_2:constant Integer := 5888; 
ERR_OBSW_DP_SINGLEDATA_PS2_MISSION_TIME_2:constant Integer := 5902; 
ERR_OBSW_DP_SINGLEDATA_HEATER1:constant Integer := 5986; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_DATA_2:constant Integer := 5951; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_GPS_TIME_2:constant Integer := 5965; 
ERR_OBSW_DP_SINGLEDATA_HEATER1_MISSION_TIME_2:constant Integer := 5979; 
ERR_OBSW_DP_SINGLEDATA_HEATER2:constant Integer := 6063; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_DATA_2:constant Integer := 6028; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_GPS_TIME_2:constant Integer := 6042; 
ERR_OBSW_DP_SINGLEDATA_HEATER2_MISSION_TIME_2:constant Integer := 6056; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER:constant Integer := 6112; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_DATA_2:constant Integer := 6077; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_GPS_TIME_2:constant Integer := 6091; 
ERR_OBSW_DP_SINGLEDATA_ANEMOMETER_MISSION_TIME_2:constant Integer := 6105; 
...
ERR_HEATER_ON_OFF:constant Integer := 2346; 
...
ERR_HTL_STATE:constant Integer := 2353; 
...
ERR_OBSW_DP_FILTER:constant Integer := 4299; 
