...
package Heattransferlab_RI is
   ...
   procedure SET_f1_max_time (Val : in out asn1SccT_UInt32);
   procedure RESET_f1_max_time;
   procedure SET_f2_max_time (Val : in out asn1SccT_UInt32);
   procedure RESET_f2_max_time;
