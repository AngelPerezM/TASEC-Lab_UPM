...
ERR_SPI_ID:constant Integer := 85; 
ERR_SPI_ID_BUS_2:constant Integer := 64; 
ERR_SPI_ID_CS_2:constant Integer := 78; 
...
ERR_I2C_ID:constant Integer := 120; 
ERR_I2C_ID_BUS_2:constant Integer := 99; 
ERR_I2C_ID_ADDRESS_2:constant Integer := 113; 
...
ERR_PS_RAW_DATA:constant Integer := 1513; 
ERR_PS_RAW_DATA_D1_2:constant Integer := 1492; 
ERR_PS_RAW_DATA_D2_2:constant Integer := 1506; 
...
ERR_TC74S_I2CBUSES:constant Integer := 1072; 
ERR_TC74S_I2CBUSES_ELM_2:constant Integer := 1065; 
...
ERR_PT1000S_CHANNELS:constant Integer := 1135; 
ERR_PT1000S_CHANNELS_ELM_2:constant Integer := 1128; 
...
ERR_PS_PROCESSED_DATA:constant Integer := 1548; 
ERR_PS_PROCESSED_DATA_PRESSURE_2:constant Integer := 1527; 
ERR_PS_PROCESSED_DATA_TEMP_2:constant Integer := 1541; 
...
ERR_DATE_TIME:constant Integer := 7596; 
ERR_DATE_TIME_DAY_2:constant Integer := 7519; 
ERR_DATE_TIME_MONTH_2:constant Integer := 7533; 
ERR_DATE_TIME_YEAR_2:constant Integer := 7547; 
ERR_DATE_TIME_HOUR_2:constant Integer := 7561; 
ERR_DATE_TIME_MINUTE_2:constant Integer := 7575; 
ERR_DATE_TIME_SECOND_2:constant Integer := 7589; 
...
ERR_MGT_RAW_DATA:constant Integer := 379; 
ERR_MGT_RAW_DATA_X_AXIS_2:constant Integer := 344; 
ERR_MGT_RAW_DATA_Y_AXIS_2:constant Integer := 358; 
ERR_MGT_RAW_DATA_Z_AXIS_2:constant Integer := 372; 
...
ERR_ACC_RAW_DATA:constant Integer := 477; 
ERR_ACC_RAW_DATA_X_AXIS_2:constant Integer := 442; 
ERR_ACC_RAW_DATA_Y_AXIS_2:constant Integer := 456; 
ERR_ACC_RAW_DATA_Z_AXIS_2:constant Integer := 470; 
...
ERR_GYRO_RAW_DATA:constant Integer := 575; 
ERR_GYRO_RAW_DATA_X_AXIS_2:constant Integer := 540; 
ERR_GYRO_RAW_DATA_Y_AXIS_2:constant Integer := 554; 
ERR_GYRO_RAW_DATA_Z_AXIS_2:constant Integer := 568; 
...
ERR_MGT_MILLIGAUSS_DATA:constant Integer := 428; 
ERR_MGT_MILLIGAUSS_DATA_X_AXIS_2:constant Integer := 393; 
ERR_MGT_MILLIGAUSS_DATA_Y_AXIS_2:constant Integer := 407; 
ERR_MGT_MILLIGAUSS_DATA_Z_AXIS_2:constant Integer := 421; 
...
ERR_ACC_MILLIG_DATA:constant Integer := 526; 
ERR_ACC_MILLIG_DATA_X_AXIS_2:constant Integer := 491; 
ERR_ACC_MILLIG_DATA_Y_AXIS_2:constant Integer := 505; 
ERR_ACC_MILLIG_DATA_Z_AXIS_2:constant Integer := 519; 
...
ERR_GYRO_MILLIDPS_DATA:constant Integer := 624; 
ERR_GYRO_MILLIDPS_DATA_X_AXIS_2:constant Integer := 589; 
ERR_GYRO_MILLIDPS_DATA_Y_AXIS_2:constant Integer := 603; 
ERR_GYRO_MILLIDPS_DATA_Z_AXIS_2:constant Integer := 617; 
...
ERR_PT1000S_RAW_DATA:constant Integer := 1177; 
ERR_PT1000S_RAW_DATA_ELM:constant Integer := 1170; 
ERR_PT1000S_RAW_DATA_ELM_VCC_VOLTS_2:constant Integer := 1149; 
ERR_PT1000S_RAW_DATA_ELM_PT1000_2:constant Integer := 1163; 
...
ERR_PT1000S_CELSIUS_DATA:constant Integer := 1198; 
ERR_PT1000S_CELSIUS_DATA_ELM_2:constant Integer := 1191; 
...
ERR_PS_CALIBRATION_DATA:constant Integer := 1478; 
ERR_PS_CALIBRATION_DATA_C1_2:constant Integer := 1317; 
ERR_PS_CALIBRATION_DATA_C2_2:constant Integer := 1331; 
ERR_PS_CALIBRATION_DATA_C3_2:constant Integer := 1345; 
ERR_PS_CALIBRATION_DATA_C4_2:constant Integer := 1359; 
ERR_PS_CALIBRATION_DATA_C5_2:constant Integer := 1373; 
ERR_PS_CALIBRATION_DATA_C6_2:constant Integer := 1387; 
ERR_PS_CALIBRATION_DATA_SENS_T1_2:constant Integer := 1401; 
ERR_PS_CALIBRATION_DATA_OFF_T1_2:constant Integer := 1415; 
ERR_PS_CALIBRATION_DATA_TCS_2:constant Integer := 1429; 
ERR_PS_CALIBRATION_DATA_TCO_2:constant Integer := 1443; 
ERR_PS_CALIBRATION_DATA_TREF_2:constant Integer := 1457; 
ERR_PS_CALIBRATION_DATA_TEMP_SENS_2:constant Integer := 1471; 
...
ERR_TC_HEATER:constant Integer := 7022; 
ERR_TC_HEATER_HEATER:constant Integer := 6987; 
ERR_TC_HEATER_COMMAND:constant Integer := 7015; 
ERR_TC_HEATER_COMMAND_POWER_MANUAL_2:constant Integer := 7001; 
ERR_TC_HEATER_COMMAND_MAX_MIN:constant Integer := 7008; 
...
ERR_GPS_PVT:constant Integer := 330; 
ERR_GPS_PVT_MODE:constant Integer := 127; 
ERR_GPS_PVT_DATE_AND_TIME_2:constant Integer := 141; 
ERR_GPS_PVT_EPT_2:constant Integer := 155; 
ERR_GPS_PVT_LATITUDE_2:constant Integer := 169; 
ERR_GPS_PVT_EPY_2:constant Integer := 183; 
ERR_GPS_PVT_LONGITUDE_2:constant Integer := 197; 
ERR_GPS_PVT_EPX_2:constant Integer := 211; 
ERR_GPS_PVT_ALTITUDE_2:constant Integer := 225; 
ERR_GPS_PVT_EPV_2:constant Integer := 239; 
ERR_GPS_PVT_COURSE_2:constant Integer := 253; 
ERR_GPS_PVT_EPD_2:constant Integer := 267; 
ERR_GPS_PVT_SPEED_2:constant Integer := 281; 
ERR_GPS_PVT_EPS_2:constant Integer := 295; 
ERR_GPS_PVT_CLIMB_2:constant Integer := 309; 
ERR_GPS_PVT_EPC_2:constant Integer := 323; 
...
ERR_HTL_CONFIG:constant Integer := 2003; 
ERR_HTL_CONFIG_PRESS_5KM_2:constant Integer := 1898; 
ERR_HTL_CONFIG_PRESS_10KM_2:constant Integer := 1912; 
ERR_HTL_CONFIG_PRESS_18KM_2:constant Integer := 1926; 
ERR_HTL_CONFIG_A1_DURATION_EMERGENCY_SECS_2:constant Integer := 1940; 
ERR_HTL_CONFIG_A1_DURATION_MAX_SECS_2:constant Integer := 1954; 
ERR_HTL_CONFIG_A2_DURATION_MAX_SECS_2:constant Integer := 1968; 
ERR_HTL_CONFIG_F1_DURATION_SECS_2:constant Integer := 1982; 
ERR_HTL_CONFIG_F2_DURATION_SECS_2:constant Integer := 1996; 
...
ERR_TC:constant Integer := 7218; 
ERR_TC_HEATER_COMMANDS:constant Integer := 7204; 
ERR_TC_HEATER_COMMANDS_HEATER_OF_HTL_2:constant Integer := 7071; 
ERR_TC_HEATER_COMMANDS_CONFIG_OF_HTL_2:constant Integer := 7197; 
ERR_TC_SYSTEM_COMMANDS:constant Integer := 7211; 
...
ERR_IMU_ALL_DATA:constant Integer := 1051; 
ERR_IMU_ALL_DATA_MGT_RAW_2:constant Integer := 680; 
ERR_IMU_ALL_DATA_MGT_MGAUSS_2:constant Integer := 736; 
ERR_IMU_ALL_DATA_ACCEL_RAW_2:constant Integer := 792; 
ERR_IMU_ALL_DATA_ACCEL_MG_2:constant Integer := 848; 
ERR_IMU_ALL_DATA_GYRO_RAW_2:constant Integer := 904; 
ERR_IMU_ALL_DATA_GYRO_MDPS_2:constant Integer := 960; 
ERR_IMU_ALL_DATA_TEMP_RAW_2:constant Integer := 974; 
ERR_IMU_ALL_DATA_TEMP_CELSIUS_2:constant Integer := 988; 
ERR_IMU_ALL_DATA_MGT_VALID_2:constant Integer := 1002; 
ERR_IMU_ALL_DATA_ACC_VALID_2:constant Integer := 1016; 
ERR_IMU_ALL_DATA_GYRO_VALID_2:constant Integer := 1030; 
ERR_IMU_ALL_DATA_TEMP_VALID_2:constant Integer := 1044; 
...
ERR_IMU_QUEUE:constant Integer := 6126; 
ERR_IMU_QUEUE_ELM:constant Integer := 6119; 
ERR_IMU_QUEUE_ELM_DATA_2:constant Integer := 6084; 
ERR_IMU_QUEUE_ELM_GPS_TIME_2:constant Integer := 6098; 
ERR_IMU_QUEUE_ELM_MISSION_TIME_2:constant Integer := 6112; 
...
ERR_TC74S_ALL_DATA:constant Integer := 1114; 
ERR_TC74S_ALL_DATA_ELM:constant Integer := 1107; 
ERR_TC74S_ALL_DATA_ELM_TEMPERATURE_2:constant Integer := 1086; 
ERR_TC74S_ALL_DATA_ELM_VALIDITY_2:constant Integer := 1100; 
...
ERR_PT1000S_ALL_DATA:constant Integer := 1303; 
ERR_PT1000S_ALL_DATA_RAW_2:constant Integer := 1247; 
ERR_PT1000S_ALL_DATA_CELSIUS_2:constant Integer := 1275; 
ERR_PT1000S_ALL_DATA_VALIDITY:constant Integer := 1296; 
ERR_PT1000S_ALL_DATA_VALIDITY_ELM_2:constant Integer := 1289; 
...
ERR_PS_ALL_DATA:constant Integer := 1835; 
ERR_PS_ALL_DATA_CALIB_2:constant Integer := 1730; 
ERR_PS_ALL_DATA_RAW_2:constant Integer := 1772; 
ERR_PS_ALL_DATA_PROCESSED_2:constant Integer := 1814; 
ERR_PS_ALL_DATA_VALIDITY_2:constant Integer := 1828; 
...
ERR_HEATER_DATA:constant Integer := 1870; 
ERR_HEATER_DATA_POWER_WATTS_2:constant Integer := 1849; 
ERR_HEATER_DATA_VALIDITY_2:constant Integer := 1863; 
...
ERR_OBSW_DP_DATA:constant Integer := 3823; 
ERR_OBSW_DP_DATA_GPS:constant Integer := 2255; 
ERR_OBSW_DP_DATA_GPS_DATA_2:constant Integer := 2220; 
ERR_OBSW_DP_DATA_GPS_GPS_TIME_2:constant Integer := 2234; 
ERR_OBSW_DP_DATA_GPS_MISSION_TIME_2:constant Integer := 2248; 
ERR_OBSW_DP_DATA_IMU:constant Integer := 2724; 
ERR_OBSW_DP_DATA_IMU_DATA_2:constant Integer := 2689; 
ERR_OBSW_DP_DATA_IMU_GPS_TIME_2:constant Integer := 2703; 
ERR_OBSW_DP_DATA_IMU_MISSION_TIME_2:constant Integer := 2717; 
ERR_OBSW_DP_DATA_TC74S:constant Integer := 2808; 
ERR_OBSW_DP_DATA_TC74S_DATA_2:constant Integer := 2773; 
ERR_OBSW_DP_DATA_TC74S_GPS_TIME_2:constant Integer := 2787; 
ERR_OBSW_DP_DATA_TC74S_MISSION_TIME_2:constant Integer := 2801; 
ERR_OBSW_DP_DATA_PT1000S:constant Integer := 2955; 
ERR_OBSW_DP_DATA_PT1000S_DATA_2:constant Integer := 2920; 
ERR_OBSW_DP_DATA_PT1000S_GPS_TIME_2:constant Integer := 2934; 
ERR_OBSW_DP_DATA_PT1000S_MISSION_TIME_2:constant Integer := 2948; 
ERR_OBSW_DP_DATA_PS1:constant Integer := 3284; 
ERR_OBSW_DP_DATA_PS1_DATA_2:constant Integer := 3249; 
ERR_OBSW_DP_DATA_PS1_GPS_TIME_2:constant Integer := 3263; 
ERR_OBSW_DP_DATA_PS1_MISSION_TIME_2:constant Integer := 3277; 
ERR_OBSW_DP_DATA_PS2:constant Integer := 3613; 
ERR_OBSW_DP_DATA_PS2_DATA_2:constant Integer := 3578; 
ERR_OBSW_DP_DATA_PS2_GPS_TIME_2:constant Integer := 3592; 
ERR_OBSW_DP_DATA_PS2_MISSION_TIME_2:constant Integer := 3606; 
ERR_OBSW_DP_DATA_HEATER1:constant Integer := 3690; 
ERR_OBSW_DP_DATA_HEATER1_DATA_2:constant Integer := 3655; 
ERR_OBSW_DP_DATA_HEATER1_GPS_TIME_2:constant Integer := 3669; 
ERR_OBSW_DP_DATA_HEATER1_MISSION_TIME_2:constant Integer := 3683; 
ERR_OBSW_DP_DATA_HEATER2:constant Integer := 3767; 
ERR_OBSW_DP_DATA_HEATER2_DATA_2:constant Integer := 3732; 
ERR_OBSW_DP_DATA_HEATER2_GPS_TIME_2:constant Integer := 3746; 
ERR_OBSW_DP_DATA_HEATER2_MISSION_TIME_2:constant Integer := 3760; 
ERR_OBSW_DP_DATA_ANEMOMETER:constant Integer := 3816; 
ERR_OBSW_DP_DATA_ANEMOMETER_DATA_2:constant Integer := 3781; 
ERR_OBSW_DP_DATA_ANEMOMETER_GPS_TIME_2:constant Integer := 3795; 
ERR_OBSW_DP_DATA_ANEMOMETER_MISSION_TIME_2:constant Integer := 3809; 
...
ERR_ATT_GUI:constant Integer := 8163; 
ERR_ATT_GUI_GPS_2:constant Integer := 7813; 
ERR_ATT_GUI_GPS_DATE_TIME_2:constant Integer := 7911; 
ERR_ATT_GUI_IMU:constant Integer := 8156; 
ERR_ATT_GUI_IMU_MGT_MGAUSS_2:constant Integer := 7967; 
ERR_ATT_GUI_IMU_ACCEL_MG_2:constant Integer := 8023; 
ERR_ATT_GUI_IMU_GYRO_MDPS_2:constant Integer := 8079; 
ERR_ATT_GUI_IMU_TEMP_CELSIUS_2:constant Integer := 8093; 
ERR_ATT_GUI_IMU_MGT_VALID_2:constant Integer := 8107; 
ERR_ATT_GUI_IMU_ACC_VALID_2:constant Integer := 8121; 
ERR_ATT_GUI_IMU_GYRO_VALID_2:constant Integer := 8135; 
ERR_ATT_GUI_IMU_TEMP_VALID_2:constant Integer := 8149; 
...
ERR_PS_GUI:constant Integer := 8212; 
ERR_PS_GUI_PRESSURE_MBAR_2:constant Integer := 8177; 
ERR_PS_GUI_TEMPERATURE_CELSIUS_2:constant Integer := 8191; 
ERR_PS_GUI_VALIDITY_2:constant Integer := 8205; 
...
ERR_ENV_GUI:constant Integer := 8422; 
ERR_ENV_GUI_PRESSURE_SENSOR_1_2:constant Integer := 8268; 
ERR_ENV_GUI_PRESSURE_SENSOR_2_2:constant Integer := 8324; 
ERR_ENV_GUI_ANEMOMETER:constant Integer := 8373; 
ERR_ENV_GUI_ANEMOMETER_GLOBAL_COUNTER_2:constant Integer := 8338; 
ERR_ENV_GUI_ANEMOMETER_TEMPERATURE_CELSIUS_2:constant Integer := 8352; 
ERR_ENV_GUI_ANEMOMETER_TEMPERATURE_VALIDITY_2:constant Integer := 8366; 
ERR_ENV_GUI_HEATER_2:constant Integer := 8415; 
...
ERR_WD_TIMEOUT:constant Integer := 50; 
...
ERR_HEATER_ON_OFF:constant Integer := 1877; 
...
ERR_HTL_STATE:constant Integer := 1884; 
...
ERR_TM:constant Integer := 6980; 
ERR_TM_STATE_HTL_2:constant Integer := 6140; 
ERR_TM_HEATER1_2:constant Integer := 6182; 
ERR_TM_HEATER2_2:constant Integer := 6224; 
ERR_TM_TC74S_2:constant Integer := 6273; 
ERR_TM_PT1000S_2:constant Integer := 6385; 
ERR_TM_GPS_2:constant Integer := 6602; 
ERR_TM_IMU:constant Integer := 6847; 
ERR_TM_IMU_MGT_MGAUSS_2:constant Integer := 6658; 
ERR_TM_IMU_ACCEL_MG_2:constant Integer := 6714; 
ERR_TM_IMU_GYRO_MDPS_2:constant Integer := 6770; 
ERR_TM_IMU_TEMP_CELSIUS_2:constant Integer := 6784; 
ERR_TM_IMU_MGT_VALID_2:constant Integer := 6798; 
ERR_TM_IMU_ACC_VALID_2:constant Integer := 6812; 
ERR_TM_IMU_GYRO_VALID_2:constant Integer := 6826; 
ERR_TM_IMU_TEMP_VALID_2:constant Integer := 6840; 
ERR_TM_PS1_2:constant Integer := 6889; 
ERR_TM_PS2_2:constant Integer := 6931; 
ERR_TM_PS1_VALIDITY_2:constant Integer := 6945; 
ERR_TM_PS2_VALIDITY_2:constant Integer := 6959; 
ERR_TM_ANEMOMETER_2:constant Integer := 6973; 
...
ERR_HTL_GUI:constant Integer := 7505; 
ERR_HTL_GUI_STATE_2:constant Integer := 7232; 
ERR_HTL_GUI_HEATER_2:constant Integer := 7274; 
ERR_HTL_GUI_DELTA_T_2:constant Integer := 7288; 
ERR_HTL_GUI_PT1000S:constant Integer := 7400; 
ERR_HTL_GUI_PT1000S_AIRE_ABAJO_2:constant Integer := 7302; 
ERR_HTL_GUI_PT1000S_AIRE_ARRIBA_2:constant Integer := 7316; 
ERR_HTL_GUI_PT1000S_PLACA_ABAJO_2:constant Integer := 7330; 
ERR_HTL_GUI_PT1000S_PLACA_ARRIBA_2:constant Integer := 7344; 
ERR_HTL_GUI_PT1000S_INFINITO_2:constant Integer := 7358; 
ERR_HTL_GUI_PT1000S_EXTERIOR_2:constant Integer := 7372; 
ERR_HTL_GUI_PT1000S_VALIDITY:constant Integer := 7393; 
ERR_HTL_GUI_PT1000S_VALIDITY_ELM_2:constant Integer := 7386; 
ERR_HTL_GUI_TC74S:constant Integer := 7498; 
ERR_HTL_GUI_TC74S_X_POSITIVE_2:constant Integer := 7414; 
ERR_HTL_GUI_TC74S_X_NEGATIVE_2:constant Integer := 7428; 
ERR_HTL_GUI_TC74S_Y_POSITIVE_2:constant Integer := 7442; 
ERR_HTL_GUI_TC74S_Y_NEGATIVE_2:constant Integer := 7456; 
ERR_HTL_GUI_TC74S_Z_TECHO_2:constant Integer := 7470; 
ERR_HTL_GUI_TC74S_VALIDITY:constant Integer := 7491; 
ERR_HTL_GUI_TC74S_VALIDITY_ELM_2:constant Integer := 7484; 
...
ERR_OBSW_DP_FILTER:constant Integer := 3830; 
