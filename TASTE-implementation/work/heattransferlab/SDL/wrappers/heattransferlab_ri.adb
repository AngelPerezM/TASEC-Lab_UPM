...
package body Heattransferlab_RI is
   ...
   procedure Recordhtlparams
      (Htl_State : in   out asn1SccHtl_State;
       ...
       F2_Max_Time : in out asn1SccT_Double) is
   ...
   begin
         C_Recoverhtlparams (htl_state, f1_max_time, f2_max_time);
