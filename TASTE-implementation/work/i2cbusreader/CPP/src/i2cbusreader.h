...
extern void i2cbusreader_RI_readAccel( asn1SccACC_MilliG_Data *, asn1SccACC_Raw_Data *, asn1SccContent_Validity * );
extern void i2cbusreader_RI_readGyro( asn1SccGYRO_MilliDPS_Data *, asn1SccGYRO_Raw_Data *, asn1SccContent_Validity * );
