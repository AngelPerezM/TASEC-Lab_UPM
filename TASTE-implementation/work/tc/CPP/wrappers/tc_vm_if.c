...

{
   ...
   static asn1SccTC_Heater IN_TC;
#ifdef __unix__
   asn1SccTC_Heater_Initialize(&IN_TC);
#endif
   if (0 != Decode_UPER_TC_Heater (&IN_TC, (void *)IN_tc, IN_tc_len)) {
      #ifdef __unix__
         puts("Error decoding TC-Heater in function TC_tc");
      #endif
      return;
   }
