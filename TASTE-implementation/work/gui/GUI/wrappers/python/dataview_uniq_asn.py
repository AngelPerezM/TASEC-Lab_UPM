...
class TC(COMMON):
    # Ordered list of fields:
    children_ordered = ['heater-of-HTL', 'config-of-HTL']
    ...
    def GSER(self):
        ...
        lines.append("{")
        lines.append(" press-5km ")
        lines.append("  "+str(self.config_of_HTL.press_5km.Get()))
        lines.append(', ')
        lines.append(" press-10km ")
        lines.append("  "+str(self.config_of_HTL.press_10km.Get()))
        lines.append(', ')
        lines.append(" press-18km ")
        lines.append("  "+str(self.config_of_HTL.press_18km.Get()))
        lines.append(', ')
        lines.append(" a1-duration-emergency-secs ")
        lines.append("  "+str(self.config_of_HTL.a1_duration_emergency_secs.Get()))
        lines.append(', ')
        lines.append(" a1-duration-max-secs ")
        lines.append("  "+str(self.config_of_HTL.a1_duration_max_secs.Get()))
        lines.append(', ')
        lines.append(" a2-duration-max-secs ")
        lines.append("  "+str(self.config_of_HTL.a2_duration_max_secs.Get()))
        lines.append(', ')
        lines.append(" f1-duration-secs ")
        lines.append("  "+str(self.config_of_HTL.f1_duration_secs.Get()))
        lines.append(', ')
        lines.append(" f2-duration-secs ")
        lines.append("  "+str(self.config_of_HTL.f2_duration_secs.Get()))
        lines.append("}")
        lines.append("}")
